%! Characteristics of Polynomial Functions — Unit 3, Lesson 3.0 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 3.0 \quad Characteristics of Polynomial Functions}}
\end{center}
