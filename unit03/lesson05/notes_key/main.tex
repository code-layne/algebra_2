%! Fundamental Theorem of Algebra and Complex Zeros — Unit 3, Lesson 3.5 — Guided Notes (Answer Key)
...
(Lesson 3.3), $(x - r_1)$ is then a \ans{factor} of $f$, so dividing leaves a quotient of degree
...
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
  ...
  \item Lesson 3.0 check: at the double zero the graph \ans{touches} the axis; at the single zero it
...
\begin{itemize}[leftmargin=1.5em, itemsep=4pt]
  ...
  \item Therefore a polynomial of \textbf{odd} degree with real coefficients must have at least
        ...
        \ans{zero} real zeros.)
  \item \textbf{Lesson 3.0 agrees.} An odd-degree graph has arms pointing in \ans{opposite}
...
literal wording of A2.EI.6b and it is the part that transfers to Lesson~3.6.
...
reuses the Lesson~2.4 conjugate product they just did in the Warm-Up. Expanding gives
$x^2-2ax+(a^2+b^2)$.
...
the board: the pairing argument, and Lesson~3.0's opposite-arm end behavior. Students who can give
