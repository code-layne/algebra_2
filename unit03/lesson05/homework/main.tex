%! The Quadratic Formula & the Discriminant — Unit 3, Lesson 3.5 — Homework
...
\begin{enumerate}[leftmargin=1.9em, itemsep=9pt]
  \item \textbf{Standard form, then $a,b,c$.}
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=4pt]
      \item $x^2=6x-2 \Rightarrow$ \blank{2.6cm}\quad $a=\blank{0.8cm}\ b=\blank{0.8cm}\ c=\blank{0.8cm}$
      \item $5x-3=2x^2 \Rightarrow$ \blank{2.6cm}\quad $a=\blank{0.8cm}\ b=\blank{0.8cm}\ c=\blank{0.8cm}$
    \end{enumerate}

  \item \textbf{Discriminant \& classify} (compute $b^2-4ac$; state two real / one repeated / two complex).
    \[ x^2-2x-8=0:\ \blank{2.6cm} \qquad x^2+x+1=0:\ \blank{2.6cm} \]
    \[ 9x^2-12x+4=0:\ \blank{2.6cm} \qquad x^2+5x+2=0:\ \blank{2.6cm} \]

  \item \textbf{Solve} (real, rational).
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=4pt]
      \item $x^2-x-6=0 \Rightarrow x=$ \blank{3.0cm}
      \item $2x^2-7x+3=0 \Rightarrow x=$ \blank{3.0cm}
    \end{enumerate}

  \item \textbf{Solve} (real, irrational --- simplest radical form).
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=4pt]
      \item $x^2-6x+7=0 \Rightarrow x=$ \blank{3.0cm}
      \item $x^2+4x+1=0 \Rightarrow x=$ \blank{3.0cm}
    \end{enumerate}

  \item \textbf{Solve} (complex --- $a+bi$ form).
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=4pt]
      \item $x^2-2x+10=0 \Rightarrow x=$ \blank{3.0cm}
      \item $x^2+16=0 \Rightarrow x=$ \blank{3.0cm}
      \item $2x^2+2x+1=0 \Rightarrow x=$ \blank{3.0cm}
    \end{enumerate}

  \item \textbf{Discriminant $\to$ graph.} State how many times each parabola crosses the $x$-axis.
    \[ b^2-4ac=49:\ \blank{1.6cm} \qquad b^2-4ac=0:\ \blank{1.6cm} \qquad b^2-4ac=-4:\ \blank{1.6cm} \]

  \item \textbf{Choose the most efficient method} (square roots / factoring / quadratic formula --- you need not solve).
    \[ x^2-25=0:\ \blank{2.6cm} \quad x^2-7x+12=0:\ \blank{2.6cm} \quad x^2+3x+5=0:\ \blank{2.6cm} \]

  \item \textbf{Explain.} A classmate says ``the discriminant is negative, so the equation has \emph{no}
        solutions.'' What is the correct statement? \writeline
\end{enumerate}
\end{notesbox}
...
\[ t=\blank{3.2cm} \Rightarrow t=\blank{1.4cm}\text{ s} \]

\textbf{2. Parameter.} For what value of $k$ does $x^2+6x+k=0$ have exactly one repeated real root?
\blank{2.0cm}\; For what values of $k$ does it have two complex roots? \blank{2.0cm}
