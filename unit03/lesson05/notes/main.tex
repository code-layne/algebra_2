%! The Quadratic Formula & the Discriminant — Unit 3, Lesson 3.5 — Guided Notes
...
\[ x=\frac{-(-2)\pm\sqrt{(-2)^2-4(1)(-3)}}{2(1)}=\frac{2\pm\sqrt{\blank{1.0cm}}}{2}=\frac{2\pm\blank{0.8cm}}{2}=\blank{2.2cm}. \]
...
\[ x=\frac{-2\pm\sqrt{-16}}{2}=\frac{-2\pm\blank{1.0cm}}{2}=\blank{2.4cm}. \]
...
\[ -16t^2+24t+6=0 \ \Rightarrow\ t=\blank{3.4cm} \ \Rightarrow\ t\approx\blank{1.6cm}\text{ s}. \]
\end{notesbox}

\begin{practicebox}
\textbf{Solve with the quadratic formula. Simplify; use $a+bi$ when needed.}
\begin{enumerate}[leftmargin=1.9em, itemsep=6pt]
  \item $x^2+2x-5=0 \Rightarrow x=\blank{3.4cm}$
  \item $2x^2-4x+3=0 \Rightarrow x=\blank{3.4cm}$
