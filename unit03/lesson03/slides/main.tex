%! Dividing Polynomials; Remainder and Factor Theorems — Unit 3, Lesson 3.3 — Slides (Beamer)
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}\setlength{\itemsep}{4pt}
        ...
        \item And yet Lesson 3.0's graph \emph{touches} at $x=1$ and \emph{crosses} at $x=-2$.
      \end{itemize}
    \end{column}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      {\footnotesize Multiplicity $2$ at $x=1$ $\Rightarrow$ the graph \emph{touches}; multiplicity
       $1$ at $x=-2$ $\Rightarrow$ it \emph{crosses}. Exactly the Lesson 3.0 graph.
...
\begin{frame}[t, plain]
  ...
  \end{center}
  \vspace{4pt}
  \begin{block}{The workflow for the rest of Unit 3}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}\setlength{\itemsep}{3pt}
        \item \textbf{3.4} The Rational Root Theorem --- the candidate list, fractions included.
