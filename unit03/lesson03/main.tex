%! Dividing Polynomials; Remainder and Factor Theorems — Unit 3, Lesson 3.3 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 3.3: Dividing Polynomials; Remainder and Factor Theorems}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    wall Lesson~3.2 ended on --- students divide a known factor out of $x^3-3x+2$ and finish a
    ...
    prerequisite for \textbf{A2.EI.6c/d} in Lessons~3.4--3.5.
\end{tcolorbox}
...
\begin{fixedskillbox}[Activate Prior Knowledge \& Spiral Review]{forestbg}
    ...
    \emph{Monomial quotients} (Algebra~1 exponent rules), including $\frac{6x^2}{6x^2}=1$ --- the
...
\begin{skillbox}[Hook]{forestbg}
    Put Lesson~3.2's unfinished business back on the board:
    \[
      p(x) = x^3 - 3x + 2 .
    \]
    ...
    it is not, because in Lesson~3.0 they read this graph and saw a \emph{touch} at $x=1$ and a
...
\]
Point at the Lesson~3.0 graph: multiplicity $2$ at $x=1$ \emph{touches}, multiplicity $1$ at $x=-2$
\emph{crosses}. Say it plainly --- \textbf{the wall from Lesson~3.2 is down.} Then a second division
...
does the candidate list come from? \textbf{Lesson~3.4.}
\end{multicols}
\end{skillbox}
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item stopping at the depressed polynomial --- the answer is not finished until every factor is prime (Lesson~3.2's standard, still in force);
...
arithmetic / stopped before factoring'' to decide what the first five minutes of Lesson~3.4 look
like --- a large ``stopped early'' pile matters most, because 3.4's entire method is test
...
factorization students produced in Lesson~3.2 by a different road; a Remainder Theorem set with
\emph{no} factors among the candidates; a full test-divide-finish problem on $x^3+2x^2-11x-12$; a
return to Lesson~3.0's exit-ticket graph of $h(x)=x^3-3x-2$, recovered as $(x+1)^2(x-2)$ by division;
...
to evaluate $f(3)$. \textbf{Preview:} Lesson~3.4, \emph{the Rational Root Theorem} --- today you
