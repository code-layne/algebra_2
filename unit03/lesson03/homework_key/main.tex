...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  ...
  \item \textbf{Complete the square to solve.} Show the completed square, then both roots.
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=6pt]
      \item $x^2+6x+2=0$ \hfill $x=$ \ans{$-3\pm\sqrt7$} \quad {\footnotesize$[(x+3)^2=7]$}
      \item $x^2-8x+5=0$ \hfill $x=$ \ans{$4\pm\sqrt{11}$} \quad {\footnotesize$[(x-4)^2=11]$}
      \item $x^2+2x-1=0$ \hfill $x=$ \ans{$-1\pm\sqrt2$} \quad {\footnotesize$[(x+1)^2=2]$}
    \end{enumerate}
  ...
  \item \textbf{Choose a method, then solve.} Name it (\emph{factoring / square roots / completing the square}).
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=6pt]
      \item $x^2-5x+6=0$ \hfill method: \ans{factoring} \quad roots: \ans{$2,\ 3$}
      \item $x^2=48$ \hfill method: \ans{square roots} \quad roots: \ans{$\pm4\sqrt3$}
      \item $x^2+10x+18=0$ \hfill method: \ans{completing the square} \quad roots: \ans{$-5\pm\sqrt7$}
    \end{enumerate}
...
\end{enumerate}
\ansline{(a) $(x+4)^2=121$. \;\; (b) $x+4=\pm11 \Rightarrow x=7$ or $x=-15$. \;\; (c) Reject $x=-15$ (a side length can't be negative); the photo's side is $x=7$ in. Check: $(7+4)^2=11^2=121$ \checkmark.}
\end{extensionbox}
