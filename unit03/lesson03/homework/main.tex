%! Solving by Square Roots & Completing the Square — Unit 3, Lesson 3.3 — Homework
...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  \item \textbf{Solve by the Square Root Property.} Both roots, simplest radical form.
    ...
    $x^2=81 \Rightarrow x=$ \blank{3.0cm} & $x^2-10=0 \Rightarrow x=$ \blank{3.0cm} \\
    $4x^2-100=0 \Rightarrow x=$ \blank{2.8cm} & $(x-1)^2=49 \Rightarrow x=$ \blank{2.8cm} \\
    \multicolumn{2}{@{}l}{$(x+3)^2=8 \Rightarrow x=$ \blank{4.0cm}} \\
    \end{tabularx}
    \end{center}

  \item \textbf{Complete the square to solve.} Show the completed square, then both roots.
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=6pt]
      \item $x^2+6x+2=0$ \hfill $x=$ \blank{3.4cm}
      \item $x^2-8x+5=0$ \hfill $x=$ \blank{3.4cm}
      \item $x^2+2x-1=0$ \hfill $x=$ \blank{3.4cm}
    \end{enumerate}
  ...
  \item \textbf{Rewrite in vertex form} $(x-h)^2+k$ by completing the square, and name the vertex.
    ...
    \hline
    $x^2+6x+1$ & \blank{3.2cm} & \blank{2.2cm} \\
    $x^2-4x-1$ & \blank{3.2cm} & \blank{2.2cm} \\
    \end{tabularx}
    \end{center}

  \item \textbf{Choose a method, then solve.} Name it (\emph{factoring / square roots / completing the square}).
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=6pt]
      \item $x^2-5x+6=0$ \hfill method: \blank{2.6cm} \quad roots: \blank{2.6cm}
      \item $x^2=48$ \hfill method: \blank{2.6cm} \quad roots: \blank{2.6cm}
      \item $x^2+10x+18=0$ \hfill method: \blank{2.6cm} \quad roots: \blank{2.6cm}
    \end{enumerate}
  ...
  \item \textbf{Roots from a graph.} The graph of $f(x)=x^2-2x-4$ is shown; its roots are irrational.
    ...
    \end{tikzpicture}
    \end{center}
    Complete the square to find the \emph{exact} roots: $x^2-2x-4=0 \Rightarrow (x-1)^2=$ \blank{1.4cm},
    so $x=$ \blank{3.0cm}. \; Do these match the two $x$-intercepts on the graph? \blank{2.0cm}

  \item \textbf{Explain.} A classmate solves $x^2=25$ and writes $x=5$. What did they miss, and what is the
        complete answer? \writeline
\end{enumerate}
\end{notesbox}
