%! Graphing Quadratic Functions & Transformations — Unit 3, Lesson 3.1 — Group Activity (Answer Key)
...
\hline
$y=(x-3)^2-2$   & \ans{$(3,-2)$}  & $x=\ans{$3$}$  & \ans{up}   & \ans{A} \\
$y=-(x+1)^2+2$  & \ans{$(-1,2)$}  & $x=\ans{$-1$}$ & \ans{down} & \ans{B} \\
$y=(x+2)^2-1$   & \ans{$(-2,-1)$} & $x=\ans{$-2$}$ & \ans{up}   & \ans{C} \\
\end{tabularx}
\end{tcolorbox}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=4pt]
  \item Axis of symmetry $x=-\dfrac{b}{2a}=\ans{$1$}$; \; vertex \ans{$(1,-4)$}; \; $y$-intercept \ans{$(0,-3)$}.
  ...
  \hline
  $x$ & $-1$ & $0$ & $1$ & $2$ & $3$ \\ \hline
  $f(x)$ & \ans{$0$} & \ans{$-3$} & \ans{$-4$} & \ans{$-3$} & \ans{$0$} \\ \hline
  \end{tabular}
  \end{center}
\end{enumerate}
...
\begin{tcolorbox}[colback=white, colframe=black!40, title=\textbf{Tier E --- Extension},
    fonttitle=\bfseries, arc=1.5mm, left=3mm, right=3mm, top=2mm, bottom=2mm, breakable]
\textbf{1. Intercept form.} For $h(x)=(x-1)(x-5)$: zeros $x=\ans{$1$}$ and $x=\ans{$5$}$; axis
$x=\ans{$3$}$; vertex \ans{$(3,-4)$}; $y$-intercept \ans{$(0,5)$}.
...
equation.
\ansline{$y=a(x+2)^2-4$. Substitute $(0,0)$: $0=a(2)^2-4=4a-4$, so $a=1$. Thus $y=(x+2)^2-4$ (equivalently $y=x^2+4x$).}

\vspace{2pt}
\textbf{3. Describe the moves.} List the transformations, \emph{in order}, that carry $y=x^2$ onto
$y=-2(x-1)^2+3$.
\ansline{Reflect over the $x$-axis and stretch vertically by a factor of $2$ (that is the $-2$), then shift right $1$ and up $3$. Result: opens down, narrower than the parent, vertex $(1,3)$.}
\end{tcolorbox}
