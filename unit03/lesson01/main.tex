%! Operations with Polynomials — Unit 3, Lesson 3.1 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 3.1: Operations with Polynomials}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    the polynomial they just built. This turns Lesson~3.0's factored forms into standard forms and
    back.
    \\[2pt]
    ...
    factoring --- is Lesson~3.2. \textbf{A2.F.2g} is revisited whenever an expanded product's degree
...
\begin{fixedskillbox}[Activate Prior Knowledge \& Spiral Review]{forestbg}
    ...
    Lesson~3.0. Debrief item~3 aloud --- ask what happened to the sign of \emph{each} of the three
    terms, not just the first.
\end{fixedskillbox}

\begin{skillbox}[Hook]{forestbg}
    Put both of Lesson~3.0's names for the anchor curve on the board:
    \[
...
behavior from Lesson~3.0 (odd degree, negative lead $\Rightarrow$ left up, right down) is known
...
cancel. Close by expanding the Hook's $(x-1)^2(x+2)$ to $x^3-3x+2$, and preview Lesson~3.2, where
...
\columnbreak
\textbf{Tier E --- Extension.} Expand Lesson~3.0's open-box model $V(x)=x(10-2x)(8-2x)$ to
...
behavior} they force (the 3.0 link); and \textbf{(3)} an \textbf{SOL-style multiple-choice} item on
...
missing-middle-term slip / like-terms slip'' to decide whether Lesson~3.2 opens with a re-teach.
\end{skillbox}
...
products including a two-variable difference of squares; expand Lesson~3.0's exit-ticket function
...
difference, then a numeric check. \textbf{Preview:} Lesson~3.2, \emph{Advanced Factoring} --- running
