...
curve from Lesson~3.0. Three predictable errors: (1) the horizontal-shift sign flip ($(x-1)$ moves
\emph{right}, not left) in \S1--\S2; (2) dropping the minus sign in $-\tfrac{b}{2a}$ in \S3; and (3)
reading the vertex of $a(x-h)^2+k$ as $(-h,k)$. Part~B of the practice foreshadows Lesson~3.2: once we
