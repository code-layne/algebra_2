%! Systems Involving Quadratics — Unit 3, Lesson 3.6 — Guided Notes
...
\vspace{2pt}
\termblanklong{System of equations}
\termblanklong{Solution of a system (ordered pair)}
\termblanklong{Point of intersection}
\termblanklong{Substitution}
\termblanklong{Linear--quadratic / quadratic--quadratic system}
\end{vocabbox}
...
\end{tikzpicture}
\end{center}
Intersection points (read from the graph): \blank{2.2cm} and \blank{2.2cm}. \\[3pt]
\textbf{Check $(3,0)$ in both:} parabola $\ (3)^2-2(3)-3=\blank{1.2cm}$; \ line $\ (3)-3=\blank{1.2cm}$. \
...
Standard form: $x^2-\blank{0.8cm}\,x=0$. \\
Factor: $x(x-\blank{0.6cm})=0\Rightarrow x=\blank{0.7cm},\ \blank{0.7cm}$. \\
Back-substitute into $y=x-3$: \ $x=0\!\to\!y=\blank{0.8cm}$, \ $x=3\!\to\!y=\blank{0.8cm}$. \\
Solutions: \ \blank{2.0cm} and \blank{2.0cm}. \\
\end{tabularx}
\end{center}
...
\hline
$y=5$  & $x^2-2x-8=0$ & \blank{1.4cm} & \blank{4.6cm} \\
$y=-4$ & $x^2-2x+1=0$ & \blank{1.4cm} & \blank{4.6cm} \\
$y=-6$ & $x^2-2x+3=0$ & \blank{1.4cm} & \blank{4.6cm} \\
\end{tabularx}
\end{center}
...
\[ x^2=-x^2+8\ \Rightarrow\ \blank{1.2cm}\,x^2=8\ \Rightarrow\ x^2=\blank{0.9cm}\ \Rightarrow\ x=\blank{1.6cm}. \]
Back-substitute into $y=x^2$: both give $y=\blank{0.8cm}$, so the solutions are \blank{2.0cm} and \blank{2.0cm}.
\begin{center}
...
equation --- at most one solution. Example: $y=x^2+1,\ y=x^2-2x+5\Rightarrow 1=-2x+5\Rightarrow x=\blank{0.8cm}$.
\end{notesbox}
...
\[ -x^2+24x=8x+48\ \Rightarrow\ x^2-16x+48=0\ \Rightarrow\ (x-4)(x-\blank{0.7cm})=0\ \Rightarrow\ x=\blank{0.7cm},\ \blank{0.7cm}. \]
So the company breaks even at $x=\blank{0.7cm}$ and $x=\blank{0.7cm}$ (hundred units); between them revenue
\emph{exceeds} cost (profit). Points: \blank{2.4cm} and \blank{2.4cm}.
\end{notesbox}
...
\begin{enumerate}[leftmargin=1.9em, itemsep=6pt]
  \item $y=x^2-4x+5,\ \ y=x+1 \Rightarrow$ \blank{4.4cm}
  \item $y=x^2-3,\ \ y=-x^2+5 \Rightarrow$ \blank{4.4cm}
  \item Without solving: how many solutions does $\ y=x^2,\ \ y=2x-1$ have? \blank{3.4cm}
\end{enumerate}
\end{practicebox}
