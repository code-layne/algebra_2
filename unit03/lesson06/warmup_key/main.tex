%! Graphing Polynomial Functions and Modeling — Unit 3, Lesson 3.6 — Warm-Up (Answer Key)
...
different part of one picture. Item 1 is the 3.0 end-behavior rule plus the 3.1 shortcut (degrees
add, leading coefficients multiply) --- watch for students who expand $(x+3)^3$ by hand, and for
$-2x(x+3)^3$ read as degree $3$. Item 2 is multiplicity from 3.0. Item 3 is new only in packaging:
