%! Graphing Polynomial Functions and Modeling — Unit 3, Lesson 3.6 — Group Activity (Answer Key)
...
\begin{enumerate}[leftmargin=1.7em, itemsep=10pt]
  \item \textbf{Factor first, then predict.} $f(x) = x^3 - x^2 - 6x$
    ...
    \vspace{2pt}
    (a) Factor completely (GCF first --- Lesson 3.2): \ans{$x(x-3)(x+2)$}
...
\begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=6pt]
  ...
  \item List the possible rational zeros of that cubic (Lesson 3.4): \ans{$\pm1,\pm2,\pm3,\pm4,\pm6,\pm12$}
...
cubic equation and is finished with the Rational Root Theorem from Lesson 3.4. Part (e) is the one
