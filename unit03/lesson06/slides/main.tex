%! Systems Involving Quadratics — Unit 3, Lesson 3.6 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}
      Substitute, reach standard form, read $b^2-4ac$ (Lesson 3.5):
    ...
    \begin{column}{0.54\textwidth}
      \begin{block}{Same three cases as 3.5}
...
\begin{frame}[t, plain]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
      \begin{block}{Next}
        \textbf{3.7 Modeling with Quadratics}
        \\[2pt]
