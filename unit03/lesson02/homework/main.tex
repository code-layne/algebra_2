...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  ...
  \item \textbf{Solve by factoring.} List all roots.
    \begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=6pt]
      \item $x^2-7x+12=0$ \hfill roots: \blank{3.0cm}
      \item $x^2+5x=0$ \hfill roots: \blank{3.0cm}
      \item $x^2=9x-20$ \hfill roots: \blank{3.0cm}
      \item $x^2-25=0$ \hfill roots: \blank{3.0cm}
    \end{enumerate}
