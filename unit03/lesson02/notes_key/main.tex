...
\begin{enumerate}[leftmargin=1.9em, itemsep=6pt]
  \item $x^2-x-6=0 \Rightarrow$ factored \ans{$(x-3)(x+2)$}; \; roots $x=\textcolor{keyred}{\mathbf{3,\,-2}}$
  \item $x^2-5x=0 \Rightarrow$ factored \ans{$x(x-5)$}; \; roots $x=\textcolor{keyred}{\mathbf{0,\,5}}$
  \item $x^2-49=0 \Rightarrow$ factored \ans{$(x-7)(x+7)$}; \; roots $x=\textcolor{keyred}{\mathbf{\pm7}}$
\end{enumerate}
\end{practicebox}
