%! Advanced Factoring — Unit 3, Lesson 3.2 — Guided Notes (Answer Key)
...
\begin{enumerate}[leftmargin=1.7em, itemsep=6pt]
  ...
  \item \textbf{The wall.} Try today's tools on the unit's anchor, $x^3 - 3x + 2$. GCF?
        ...
        \ans{No} \; And yet it \emph{does} factor --- you saw it as $(x-1)^2(x+2)$ in Lesson 3.0.
        What that means: \ansline{Today's tools do not reach every polynomial --- we need a new one (division), which is Lesson 3.3.}
\end{enumerate}
\end{practicebox}
...
creates the need for Lesson~3.3. If time is short, cut Section~3's two-variable line rather than
item~6.
\end{teachernote}
