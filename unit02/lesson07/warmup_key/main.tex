%! Modeling with Quadratics — Unit 2, Lesson 2.7 — Warm-Up (Answer Key)
...
\vspace{4pt}
\textbf{1. Find the vertex} (Lesson 2.1). For $f(x)=-x^2+4x+1$, use $x=-\dfrac{b}{2a}$, then evaluate.
\[
...
\vspace{4pt}
\textbf{2. Solve by factoring} (Lesson 2.2). Set each factor to zero.
\[
