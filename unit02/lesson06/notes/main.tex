%! Systems Involving Quadratics — Unit 2, Lesson 2.6 — Guided Notes
...
substitution you get a quadratic; its \textbf{discriminant} $b^2-4ac$ (Lesson 2.5) tells you which --- \emph{before}
...
\end{tabularx}
\end{center}
\emph{Same rule as Lesson 2.5:} $b^2-4ac>0\Rightarrow 2$ points, $=0\Rightarrow 1$ (tangent), $<0\Rightarrow 0$.
\end{notesbox}
