%! Systems Involving Quadratics — Unit 2, Lesson 2.6 — Homework (Answer Key)
...
\begin{spiralbox}
\textbf{Coming next --- Lesson 2.7: Modeling with Quadratics.} You've now solved single quadratics \emph{and}
