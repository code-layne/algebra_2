%! Absolute Value Functions \& Transformations — Unit 2, Lesson 2.3 — Homework
...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  ...
  \item \textbf{Model it.} A drone flies in a straight line past a tower; its distance from the tower
        ...
        \begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=4pt]
          \item Find the vertex and say what it means in context. \blank{5.5cm}
          \item What is the distance at $t=0$ and at $t=10$? \blank{4.5cm}
        \end{enumerate}
