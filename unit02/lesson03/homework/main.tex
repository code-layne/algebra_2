%! Solving by Square Roots & Completing the Square — Unit 2, Lesson 2.3 — Homework
...
\newcommand{\MethodA}{\blank{2.6cm}}
\newcommand{\MethodB}{\blank{2.6cm}}
\newcommand{\MethodC}{\blank{2.6cm}}
...
\begin{spiralbox}
\textbf{Coming next --- Lesson 2.4: Complex Numbers.} Every method so far stops at the same wall: what is
