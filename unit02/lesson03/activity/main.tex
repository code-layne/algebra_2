...
\begin{enumerate}[leftmargin=1.7em, itemsep=9pt]
  ...
  \item \textbf{Read the graph.} The V below is one absolute value function.
        ...
        \end{tikzpicture}
        \end{center}
        Vertex $(\blank{0.7cm},\,\blank{0.7cm})$; \; axis $x=\blank{0.8cm}$; \; minimum value
        \blank{0.8cm}; \; range \blank{1.6cm}.
  \item \textbf{Match} each equation to its graph (write A or B).
        ...
        \end{tikzpicture}
        \end{center}
        $y=|x-2|$ is graph \blank{1.0cm}. \qquad $y=|x|+2$ is graph \blank{1.0cm}.
\end{enumerate}
\end{tcolorbox}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=10pt]
  \item \textbf{Name the features} of each function.
        ...
        (a) $y=|x-2|+1$ & \blank{1.6cm} & \blank{1.2cm} & \blank{1.2cm} & \blank{1.6cm} \\
        (b) $y=-|x+3|$   & \blank{1.6cm} & \blank{1.2cm} & \blank{1.2cm} & \blank{1.6cm} \\
        (c) $y=2|x|-4$   & \blank{1.6cm} & \blank{1.2cm} & \blank{1.2cm} & \blank{1.6cm} \\
        \end{tabularx}
        \end{center}
  \item \textbf{Match} each equation to a graph (write I, II, or III).
        ...
        \end{tikzpicture}
        \end{center}
        $y=2|x|$ is \blank{0.9cm}. \quad $y=|x-3|+1$ is \blank{0.9cm}. \quad $y=-|x+2|+2$ is \blank{0.9cm}.
  \item \textbf{Describe the transformation} from $y=|x|$ to $y=-|x-1|+3$, then give the new vertex.
        \writeline
        Vertex: $(\blank{0.8cm},\,\blank{0.8cm})$.
  \item \textbf{Evaluate.} For $g(x)=3|x-2|-1$: \quad $g(2)=\blank{1.4cm}$ \qquad $g(4)=\blank{1.4cm}$.
\end{enumerate}
\end{tcolorbox}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=10pt]
  \item \textbf{Model it.} A cyclist rides straight toward a water station, reaches it $4$ minutes in,
        ...
        \begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=5pt]
          \item What is the vertex of this graph, and what does it mean in context? \writeline
          \item How far from the station is she at $t=0$ and at $t=7$? \blank{4.5cm}
        \end{enumerate}
  \item \textbf{Build the equation from a graph.} The V below opens down.
        ...
        \end{tikzpicture}
        \end{center}
        Vertex $(\blank{0.8cm},\,\blank{0.8cm})$; using a second point, $a=\blank{1.2cm}$;
        equation $y=\blank{3.4cm}$.
  \item \textbf{Reason.} For $y=a|x-h|+k$, explain how you know from $a$ alone whether the vertex is a
        \emph{maximum} or a \emph{minimum}, and state the range in each case. \writelines{2}
\end{enumerate}
\end{tcolorbox}
