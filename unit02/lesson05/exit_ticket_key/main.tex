%! The Quadratic Formula & the Discriminant — Unit 2, Lesson 2.5 — Exit Ticket (Answer Key)
...
\begin{enumerate}[leftmargin=1.8em, itemsep=14pt]
  ...
  \item \textbf{SOL-style multiple choice.} A quadratic equation has discriminant $b^2-4ac=-8$. Which best
        ...
        \begin{itemize}[leftmargin=1.4em, nosep]
          \item[] $b^2-4ac<0$ gives two complex-conjugate roots. \textbf{D} is the trap --- a negative discriminant does \emph{not} mean ``no solutions,'' it means \emph{complex} solutions (Lesson 2.4).
        \end{itemize}
\end{enumerate}
