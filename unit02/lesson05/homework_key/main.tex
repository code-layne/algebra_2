%! Linear Regression — Unit 2, Lesson 2.5 — Homework (Answer Key)
...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  ...
  \item \textbf{Interpret and predict.} A biologist records the number of \emph{days} a plant has grown
        ...
        \begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=4pt]
          ...
          \item Predict the height at $x=20$ days: $\hat y={\color{keyred}\mathbf{21}}$ cm. Interpolation or
                extrapolation? \ans{interpolation ($20$ is within $0$--$30$)}
          \item Predict at $x=100$ days: $\hat y={\color{keyred}\mathbf{85}}$ cm. Why is this prediction
                unreasonable?
