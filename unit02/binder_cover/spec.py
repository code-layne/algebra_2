"""Unit 2 binder-cover content spec.

Consumed by shared/cover.py. Every element below is lifted from a Unit 2
...
graph (2.0), a factoring solve (2.2), a completing-the-square solve (2.3),
and a linear--quadratic system (2.6). The one quadratic that will not yield a
