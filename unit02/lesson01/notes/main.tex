%! Graphing Quadratic Functions & Transformations — Unit 2, Lesson 2.1 — Guided Notes
...
\termblanklong{Intercept (factored) form}
\termblanklong{Horizontal shift $f(x-h)$}
\termblanklong{Vertical stretch / reflection $a\,f(x)$}
\end{vocabbox}
...
\begin{itemize}\setlength{\itemsep}{1pt}
  \item Which one shows the \textbf{vertex} at a glance? \writeline
  \item Which one shows the \textbf{zeros} at a glance? \writeline
\end{itemize}
...
\hline
$f(x)+k$ & shifts \blank{2.6cm} ($k>0$) or down ($k<0$) & $(0,\ \blank{0.7cm})$ \\
$f(x-h)$ & shifts \blank{2.6cm} $h$ units (careful: sign flips!) & $(\blank{0.7cm},\ 0)$ \\
$a\,f(x)$, $a>0$ & \blank{2.0cm} if $a>1$, wider if $0<a<1$ & $(0,0)$ \\
$-f(x)$ & reflects over the \blank{1.6cm}-axis (opens down) & $(0,0)$ \\
\end{tabularx}
\end{center}
...
\begin{enumerate}[leftmargin=1.6em, itemsep=3pt]
  \item Match to $a(x-h)^2+k$: $a=\blank{0.7cm}$, $h=\blank{0.7cm}$, $k=\blank{0.9cm}$.
  \item \textbf{Vertex} $(h,k) = (\blank{0.7cm},\ \blank{0.9cm})$; \textbf{axis of symmetry} $x=\blank{0.8cm}$.
  \item Since $a=1>0$, it opens \blank{1.4cm}, so the vertex is a \textbf{minimum} with min value $\blank{0.9cm}$.
  \item \textbf{Check it is the same curve.} Expand: $(x-1)^2-4 = \blank{3.6cm}$ --- standard form!
\end{enumerate}
\end{notesbox}
...
\begin{enumerate}[leftmargin=1.6em, itemsep=4pt]
  \item \textbf{Axis:} $x=-\dfrac{b}{2a}=-\dfrac{-6}{2(1)}=\blank{0.9cm}$.
  \item \textbf{Vertex:} substitute that $x$: $f(3)=(3)^2-6(3)+5=\blank{1.0cm}$, so the vertex is $(\blank{0.7cm},\ \blank{0.9cm})$.
  \item \textbf{$y$-intercept:} $(0,\ \blank{0.7cm})$.
  \item Opens \blank{1.2cm} ($a>0$); range \blank{2.2cm}.
\end{enumerate}
\end{minipage}%
...
\begin{enumerate}[leftmargin=1.9em, itemsep=3pt]
  \item $y=(x-2)^2-1 \Rightarrow$ vertex \blank{1.6cm}, opens \blank{1.0cm}, graph \blank{0.8cm}
  \item $y=-(x-1)^2+3 \Rightarrow$ vertex \blank{1.6cm}, opens \blank{1.0cm}, graph \blank{0.8cm}
  \item $y=(x+2)^2+1 \Rightarrow$ vertex \blank{1.6cm}, opens \blank{1.0cm}, graph \blank{0.8cm}
\end{enumerate}
\textbf{B. Intercept form.} For $q(x)=(x+1)(x-3)$: zeros $x=\blank{1.0cm}$ and $x=\blank{1.0cm}$; axis
$x=\blank{0.9cm}$; vertex $\blank{1.8cm}$.
\end{practicebox}
