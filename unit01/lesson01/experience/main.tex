...
% Check Your Understanding 1-2pp (in-class practice, NOT scored — homework is in DeltaMath).
...
% The lesson's in-class practice set — graded homework is in DeltaMath — so the six items carry the whole
...
Six exercises --- the lesson's practice.  Use these if you are having trouble, and bring to study hall
or office hours to get some help.
