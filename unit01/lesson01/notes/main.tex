...
% Gradual release (user direction, 2026-08-31): the notes are the "I do / we do" block, 15 minutes.
% The worked thread is a phone plan; the group activity then applies the same moves to two gyms.
