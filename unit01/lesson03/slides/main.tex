...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{4pt}
    \item \textbf{1.4} Piecewise-defined functions --- the V is two lines pasted at the vertex.
    \item \textbf{1.5} Linear regression.
  \end{itemize}
  \vspace{4pt}
  {\footnotesize The solutions of $|x-1|=2$ from Lesson 1.2 are where this V meets the line $y=2$.}
\end{frame}
