...
% vocabulary is BUILT HERE, before the practice uses it. Budget: 4pp, with Individual Practice
% landing on its own clean page. One worked context runs through every section: the trail.
...
\blank{0.7cm}, and $x$ and $-x$ give the \emph{same} output --- so the graph is a mirror image
across the $y$-axis.
\end{minipage}
\end{center}
