...
% GRADUAL RELEASE: the "you do alone" block, started in the last 10 minutes of class and finished
% at home. Every lesson generates a homework page (user direction, 2026-08-31); the teacher may
% substitute a DeltaMath set where the content is available there. This page IS scored.
% Due date (course policy, 2026-09-03): the first class after two study halls — never "next class".
% Budget: 2pp, and 2pp is a ceiling.
...
% Six items spanning A2.F.1b/c and A2.F.2a/c/d/f: the core procedure off a RULE; the CONTRAST
% PAIR (the target misconception); a GRAPH and a TABLE; the SPECIAL CASES and their boundary; a
% MODEL with a solve; the SOL-style MULTIPLE-CHOICE formative check.
...
\begin{enumerate}[leftmargin=1.9em, itemsep=3pt]
  ...
  \item \textbf{Multiple choice (SOL-style).} Which describes how the graph of $y=|x+4|-2$ is
    ...
    \begin{tabular}{@{}p{0.46\linewidth}p{0.46\linewidth}@{}}
      A.\; Shift right $4$ and down $2$ & B.\; Shift left $4$ and down $2$ \\
