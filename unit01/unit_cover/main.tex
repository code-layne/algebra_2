...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north, align=center, inner sep=0pt, text width=\paperwidth]
    at ([yshift=-0.30in]current page.north) {%
      ...
      {\color{white}\bfseries\fontsize{19}{23}\selectfont Unit 1: Linear Functions}\\[11pt]%
    };
\end{tikzpicture}
...
\begin{tcolorbox}[colback=forestbg,colframe=forest,boxrule=0.9pt,arc=2mm,
  ...
  Unit 1 opens the function-family study with the simplest family of all: the line.
...
\begin{skillbox}[Virginia SOL Standards Addressed in Unit 1]{sky}
