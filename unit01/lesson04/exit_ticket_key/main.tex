%! Piecewise \& Step Functions — Unit 1, Lesson 1.4 — Exit Ticket (Answer Key)
...
\begin{enumerate}[leftmargin=1.8em, itemsep=14pt]
  \item \textbf{Evaluate.} For $f(x)=\begin{cases} 3x, & x<1 \\ x+4, & x\ge 1 \end{cases}$
        ...
        \ansline{the bottom piece $x+4$, because $1\ge 1$ --- the boundary belongs to the $\ge$ piece.}
  ...
  \item \textbf{Read the graph.} The piecewise function below is shown.
        ...
        \ansline{No --- the graph jumps from $-1$ (open) up to $1$ (closed); the two pieces disagree at $x=0$.}
