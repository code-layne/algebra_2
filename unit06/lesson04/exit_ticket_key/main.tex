%! Graphing Radical Functions \& Transformations — Unit 6, Lesson 6.4 — Exit Ticket (Answer Key)
...
\begin{teachernote}
\small Graded for completion. Four piles, and they decide how 6.5 opens.
\begin{itemize}[leftmargin=1.3em, nosep]
  ...
  \item \textbf{Did not factor} --- item 3 $=$ A. The pile that matters: a \emph{procedural} gap that
        resurfaces in 6.5, where $\sqrt{2x-10}=4$ must be handled correctly.
\end{itemize}
