%! Modeling with Exponential Functions: Interest, Half-Life, and e — Unit 6, Lesson 6.4 — Guided Notes
...
Lesson 6.1 built $y=ab^{x}$, where $b$ was the growth factor for \emph{one} year and $x$ counted
...
$P=$ \blank{1.6cm} \quad $r=$ \blank{1.6cm} \quad $n=$ \blank{1.2cm} \quad $t=$ \blank{1.2cm}
  & \emph{$4\%$ becomes $0.04$ --- Lesson 6.1's translation, unchanged.} \\
...
quarter. They change continuously, so $e$ is their natural base --- which is why it comes back in Unit 7.
\end{notesbox}
...
\vspace{3pt}
\textbf{Will the tracer ever be completely gone?} \blank{2.0cm} --- and the reason is Lesson 6.0's, not
...
\begin{itemize}[leftmargin=1.3em, itemsep=2pt]
  ...
  \item Now try Step 1 of Lesson 6.3 on $(1.05)^{t}=2$: rewrite both sides over one base.
        \blank{4.6cm}
...
\begin{enumerate}[leftmargin=1.7em, itemsep=5pt]
  ...
  \item Which of these can be solved with Lesson 6.3's common-base method, and which cannot? Circle
