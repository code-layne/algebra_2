%! Solving Radical Equations \& Extraneous Solutions — Unit 6, Lesson 6.5 — Slides (Beamer)
...
\begin{frame}[plain]
  ...
  \begin{minipage}{0.9\textwidth}
    {\color{goldacc}\bfseries\small LESSON 6.5}\\[0.5cm]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \begin{block}{What the equation is really asking}
        This is 6.0's $f(x)=\sqrt{x+4}-1$. \\[3pt]
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{block}{Stop here}
        From Lesson 6.1: an even root is the \textbf{principal} root, and a principal root is
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{5.6} Rational equations --- the same structure: a non-reversible step produces
          candidates, and only the check promotes them.
    \item \textbf{6.1--6.4} Principal roots, the index rule, and the graphs you just used as the two
          sides of an equation.
    \item \textbf{6.6} Composition of functions --- one operation feeding another, $(f\circ
          g)(x)=f(g(x))$, where the order matters.
    \item \textbf{6.7} Inverse functions --- composition becomes the \emph{test}, and 6.0's
