%! Solving Radical Equations \& Extraneous Solutions — Unit 6, Lesson 6.5 — Guided Notes (Answer Key)
...
\begin{itemize}[leftmargin=1.3em, nosep]
  \item \textbf{The Hook is the whole lesson.} Do not let anyone hunt for a bad step; there isn't
        ...
        came from.}
  \item \textbf{Section 2's graph} is the payoff of 6.4. The two red points $(2,3)$ and $(2,-3)$ are
