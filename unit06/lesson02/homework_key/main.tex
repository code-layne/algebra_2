%! Simplifying Radicals; Adding \& Subtracting — Unit 6, Lesson 6.2 — Homework (Answer Key)
...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  \item \textbf{Simplify each numeric radical.} Watch the index --- it tells you the group size.
    ...
    (e) $8\cdot5$. \; (f) $-27\cdot5$ --- an odd index accepts a negative radicand (Lesson 6.1). \;
...
\begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=5pt]
  ...
  \item From $L=2$ to $L=8$ the length is multiplied by $4$. By what factor is the period
        ...
        a $2\times$ change in $T$. (Same story as Lesson 6.1's $\frac34$ exponent, and the same
        flattening shape read off the square root graph in 6.0.)}
...
radicand under an odd index is legal, and students who internalized 6.0's ``even index refuses
...
breaks 6.3's multiplication work first.
...
poorly; naming it as improper-fraction-to-mixed-number ties it to Lesson 6.1 and to Warm-Up item 3,
...
problem in 6.1 and the free-fall model in 6.0: a radical model, a table of values chosen to come
...
why the clockmaker's instinct fails. Part (e) is a legitimate preview of 6.3: making the
