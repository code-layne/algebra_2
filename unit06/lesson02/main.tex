%! Simplifying Radicals; Adding \& Subtracting — Unit 6, Lesson 6.2 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 6.2: Simplifying Radicals; Adding \& Subtracting}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    of radicals and derive both from the exponent rules of Lesson 6.1, rather than memorizing them;
    ...
    rationalizing are deliberately held for Lesson 6.3, which is why this pair of lessons splits
    ...
    \textbf{A2.F.1b/c} (vertical stretch of a radical parent) ahead of Lesson 6.4.
\end{tcolorbox}
...
\textbf{Product Property} & \TallMath{\sqrt[n]{ab}=\sqrt[n]{a}\cdot\sqrt[n]{b}} --- follows from $(ab)^{1/n}=a^{1/n}b^{1/n}$. For an \emph{even} index, $a,b\ge0$ (Lesson 6.1). \\
...
\textbf{Simplest radical form} & (1) no factor of the radicand is a perfect $n$th power; (2) no fraction under the radical; (3) no radical in a denominator. Condition 3 is Lesson 6.3's job. \\
...
\textbf{Rationalizing} & Clearing a radical out of a denominator --- named today, taught in Lesson 6.3. \\
\end{tabularx}
\end{skillbox}
...
pieces are not real --- and connect it to the 6.1 exit ticket: this is where a student who cannot
...
$\sqrt[4]{48}$, and $\sqrt[3]{-24}$ (odd index, negative radicand --- a 6.1 callback worth naming).
...
(6.1's $|a|$ rule is set aside, not repealed).
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item \textbf{over-applying 6.0} --- marking $\sqrt[3]{-135}$ undefined because ``negatives are not allowed'' (odd index; they are);
...
6.4: a table showing $f(x)=\sqrt{8x}$ is always twice $g(x)=\sqrt{2x}$, proved by
...
piles govern how 6.3 opens: distributing over radicals magnifies both errors immediately, since
...
2\pi$. Its shape deliberately matches 6.1's Kepler model: a table of exact values, a growth-rate
...
performed before the word exists. \textbf{Preview:} Lesson 6.3, \emph{Multiplying \& Dividing
...
that made $a+bi$ real back in Lesson 3.4).
\end{skillbox}
\end{document}
