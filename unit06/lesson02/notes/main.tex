%! Simplifying Radicals; Adding \& Subtracting — Unit 6, Lesson 6.2 — Guided Notes
...
\blank{3.6cm}, or the pieces do not exist as real numbers in the first place. That is Lesson 6.1's
...
\begin{enumerate}[leftmargin=1.7em, itemsep=2pt]
  ...
  \item there is no radical in a \blank{2.0cm}. \; \emph{(Condition 3 is Lesson 6.3's job.)}
\end{enumerate}
...
we did not know that, $\sqrt{x^{2}}$ would have to be written \blank{1.2cm} --- Lesson 6.1's
absolute-value rule.
\end{notesbox}
