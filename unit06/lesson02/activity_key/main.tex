%! Simplifying Radicals; Adding \& Subtracting — Unit 6, Lesson 6.2 — Group Activity (Answer Key)
...
Lesson 6.4 --- simplifying $\sqrt{8x}$ into $2\sqrt{2x}$ reveals a \textbf{vertical stretch}, the
