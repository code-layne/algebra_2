%! Graphing Exponential Functions and Transformations — Unit 6, Lesson 6.2 — Group Activity (Answer Key)
...
the reason --- its asymptote is below the $x$-axis --- is the payoff of Lesson 6.0's ``no zeros ever.''
...
$5$, and Lesson 6.0's rule is that growth versus decay is read off $b$ against $1$, never off $a$.
...
exponential analogue of the input/output equivalence students met for radicals in Lesson 5.4. Part (d)
...
realistic range are different objects. Part (f) hits Lesson 6.4's wall on purpose --- $0.85$ and
$\frac{8}{33}$ share no convenient base. Leave it standing; do not mention logarithms. Lesson 6.3 will
solve the ones that \emph{do} cooperate, and Unit 7 will come back for this one.
