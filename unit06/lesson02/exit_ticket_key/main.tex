%! Simplifying Radicals; Adding \& Subtracting — Unit 6, Lesson 6.2 — Exit Ticket (Answer Key)
...
\begin{itemize}[leftmargin=1.3em, nosep]
  ...
  \item \textbf{Did not simplify first} --- 1(d) answered ``cannot combine.'' They applied the
        ...
        not landed yet, and 6.3's distributing work will magnify it.
\end{itemize}
