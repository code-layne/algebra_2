%! $n$th Roots \& Rational Exponents — Unit 6, Lesson 6.1 — Exit Ticket (Answer Key)
...
\begin{itemize}[leftmargin=1.3em, nosep]
  ...
  \item \textbf{Even/odd confusion} --- item 2 answered without reference to the denominator, or
        claiming both are real. This pile is the one that matters most: 6.2's product and quotient
