%! Exponential Growth and Decay — Unit 6, Lesson 6.1 — Group Activity (Answer Key)
...
\begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=6pt]
  ...
  \item Leak A empties the tank. On what day? \ans{day 4} \; Leak B never does.
        Use Lesson 6.0's language --- \textbf{asymptote} --- to explain why not.
...
\textbf{Tier E Part 3} is the linear-versus-exponential contrast from Lesson 6.0's fingerprint test,
now in context, and it sets up two later lessons at once: the contextual-domain question returns in
6.4's modeling, and part (e) is a rehearsal for 6.5's ``extrapolation breaks'' beat. Both tanks
