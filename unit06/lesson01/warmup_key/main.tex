%! Exponential Growth and Decay — Unit 6, Lesson 6.1 — Warm-Up (Answer Key)
...
\vspace{5pt}
\textbf{2. Reading $a$ and $b$ (Lesson 6.0).} Fill in the table from the equation alone.
\begin{center}
...
\textbf{Item 2} is a straight recall check from Lesson 6.0. Anyone who cannot pull $a$ and $b$ off the
