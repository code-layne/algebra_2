%! Inverse Functions — Unit 6, Lesson 6.7 — Guided Notes
...
$g\big(f(x)\big)=\sqrt{x^{2}}=\blank{1.2cm}$ \; (Lesson 6.1) --- which is \emph{not} $x$ when $x<0$ \\
\end{tabularx}
\end{center}
\vspace{-2pt}
...
\blank{2.4cm} undoes a square root. That is what ``inverse families'' meant back in Lesson 6.0.
