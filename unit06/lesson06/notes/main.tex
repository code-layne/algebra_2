%! Composition of Functions — Unit 6, Lesson 6.6 — Guided Notes
...
From Lesson 6.4, that is the parent shifted \blank{2.4cm}. &
From Lesson 6.4, that is the parent shifted \blank{2.4cm}. \\
\end{tabularx}
\end{center}
\begin{center}
...
\textbf{$(g\circ f)(x)=\sqrt{x^{2}}=$ \blank{1.4cm}} \; (Lesson 6.1!) \\
\hline
