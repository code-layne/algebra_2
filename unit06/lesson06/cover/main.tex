%! Composition of Functions — Unit 6, Lesson 6.6 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 6.6 \quad Composition of Functions}}
\end{center}
...
\begin{enumerate}[leftmargin=1.5em, itemsep=5pt]
  ...
  \item \ldots{} take a function apart --- write $h(x)$ as $f(g(x))$ --- and recognize that every transformation from Lesson 6.4 was a composition all along.
\end{enumerate}
...
gives $\sqrt{x}-4$. You already know both of those graphs from Lesson 6.4, and they do not even have
...
to that. In Lesson 6.7 it turns out to be the whole reason $y=x^{2}$ needs a restricted domain
