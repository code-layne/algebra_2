%! Modeling with Exponential Functions: Interest, Half-Life, and e — Unit 7, Lesson 7.4 — Homework
...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  ...
  \item \textbf{Read the doubling off the graph.} \$800 is invested at $6\%$ compounded annually, so
    ...
    \vspace{3pt}
    \textbf{(d)} Try Step 1 of Lesson 7.3 on it. What stops you? \blank{4.0cm}
    \end{minipage}
    \end{center}
