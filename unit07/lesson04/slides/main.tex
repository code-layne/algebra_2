%! Modeling with Exponential Functions: Interest, Half-Life, and e — Unit 7, Lesson 7.4 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  \end{columns}
  \vspace{5pt}
  \begin{center}{\footnotesize This is still Lesson 7.1's $y=ab^{x}$ --- only the length of ``one
...
\begin{frame}[t, plain]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      \begin{block}{Two Lesson 7.0 facts, still true}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.56\textwidth}
      ...
      \begin{itemize}\setlength{\itemsep}{3pt}
        ...
        \item Step 1 of Lesson 7.3: rewrite both sides over one base. \textbf{$2$ is not a power of
              $1.05$.}
      \end{itemize}
      \vspace{3pt}
...
\begin{frame}[t, plain]
  ...
  interest, continuous growth with $e$, half-life, and doubling time. Decay models keep Lesson 7.0's
  asymptote: they approach zero forever and never arrive.\\[8pt]
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{7.5} Exponential regression --- real data, no one to hand you the rate, and the
          fingerprint test from 7.0 decides the family.
    \item \textbf{Unit 8} Logarithms --- the tool that finally names every crossing point we could only
          bracket.
  \end{itemize}
  \vspace{6pt}
  \begin{center}
