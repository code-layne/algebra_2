%! Modeling with Exponential Functions: Interest, Half-Life, and e — Unit 7, Lesson 7.4 — Group Activity (Answer Key)
...
\ansline{$17\div5=3.4$ halvings --- a fractional exponent is a legal exponent (Lesson 6.1), and $t$ does not have to land on a half-life.}
...
exponential equation. Reduce it, then decide whether Lesson 7.3's common-base method finishes the job.
...
logarithm question --- tell them so, and tell them it is Unit 8. Do not derive it.
...
exists, the method failed} --- the distinction Lesson 7.3 established and Unit 8 resolves. Any group
