%! Modeling with Exponential Functions: Interest, Half-Life, and e — Unit 7, Lesson 7.4 — Homework (Answer Key)
...
\begin{enumerate}[leftmargin=1.9em, itemsep=11pt]
  ...
  \item \textbf{Read the doubling off the graph.} \$800 is invested at $6\%$ compounded annually, so
    ...
    \vspace{3pt}
    \textbf{(d)} Try Step 1 of Lesson 7.3 on it. What stops you? \ans{$2$ is not a power of $1.06$ --- there is no common base}
    \end{minipage}
    \end{center}
...
\ansline{\hspace{1.2em} $b=0.18$ would mean the truck keeps only $18\%$ of its value each year --- Lesson 7.1's percent-as-base error.}
...
\begin{spiralbox}
\textbf{Coming next --- Lesson 7.5: Exponential Regression \& Choosing a Model.} Today every model was
handed to you: a rate, a half-life, a doubling time. Real data arrives as a pile of points with nobody
to tell you which family it belongs to. Next lesson you bring back Lesson 7.0's fingerprint test ---
...
common base. Unit 8 is where you finally write those answers down.
\end{spiralbox}
...
that Lesson 8.4 exists to fix; flag those papers and open Lesson 7.5 with thirty seconds on the graph.
...
mathematically correct and physically wrong, which is exactly the kind of judgement Lesson 7.5's
