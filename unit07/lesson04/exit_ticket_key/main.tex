%! Modeling with Exponential Functions: Interest, Half-Life, and e — Unit 7, Lesson 7.4 — Exit Ticket (Answer Key)
...
7.1 and has not registered that compounding happens more than once a year. \textbf{C} divides the time
...
it is the misconception Lesson 7.3's exit ticket was written to catch, arriving one day later in a real
context. A class with several ``no'' answers cannot start Unit 8 --- five minutes on the Section 4
...
\textbf{Item 2's last part is Lesson 7.0 arriving in a context where it matters clinically.} Accept
``horizontal asymptote'' or ``the range never includes $0$''; do not accept ``because you can always
halve again'' without the graph feature named. A student who answers ``yes'' has reverted to the Unit 6
endpoint habit that 7.0 was built to break.
...
\emph{wall} pile is the one that changes how Lesson 7.5 and Unit 8 open.
\end{teachernote}
