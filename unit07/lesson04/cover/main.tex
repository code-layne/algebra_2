%! Modeling with Exponential Functions: Interest, Half-Life, and e — Unit 7, Lesson 7.4 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 7.4 \quad Modeling: Compound Interest, Half-Life, and $e$}}
\end{center}
...
\begin{remindbox}
\small Everything today is Lesson 7.1's $y=ab^{x}$ in a costume, and one sentence keeps the costumes
...
$t/h=1.5$ is normal and not a mistake. Two Lesson 7.0 facts stay in force: a decay model has range
...
is not a power of $1.05$. That is not ``no solution.'' It is the gap Unit 8 was invented to close.
\end{remindbox}
