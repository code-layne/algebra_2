%! Exponential Growth and Decay — Unit 7, Lesson 7.1 — Homework (Answer Key)
...
tool we do not have yet --- that is what Unit 8 is for.\\[3pt]
...
\begin{spiralbox}
\textbf{Coming next --- Lesson 7.2: Graphing Exponential Functions \& Transformations.} You can now
build $y=ab^{x}$. Next you will move it: shift it, stretch it, and flip it, using the same
transformation rules you have applied since Unit 2. One of them behaves differently here than
...
$y=8\cdot 2^{-x}$. In 7.2 that stops being a curiosity and becomes a rule --- reflecting an
...
it must be diagnosed with the Lesson 7.0 fingerprint test rather than by eye. Accept ``linear'' with
...
\textbf{The Extension sets up two future lessons.} Part (d) is the wall Lesson 7.4 ends on, arriving
a few days early on purpose --- do not let students grind at it, and do not hint that logarithms
exist unless someone asks. Part (e) reruns Lesson 7.0's asymptote-believability question in a new
context, and part (c) is the reading-a-crossing-from-a-table skill that 7.3 will make algebraic in
