%! Exponential Growth and Decay — Unit 7, Lesson 7.1 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  $100\%$ of it remains each day & $0$ & neither & $1$ --- the \emph{illegal} base from 7.0 \\
...
\begin{frame}[t, plain]
  ...
  \vspace{4pt}
  \begin{center}
    {\footnotesize This is the skill Lesson 7.5 needs: technology will hand you $a$ and $b$, and you
...
\begin{frame}[t, plain]
  ...
  context.\\[8pt]
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{7.2} Graphing \& transformations --- $f(x)+k$ is the one that \emph{moves the asymptote}, and $2^{-x}=\left(\frac12\right)^{x}$ becomes the reflection rule.
    ...
    \item \textbf{7.5} Exponential regression --- technology hands you $a$ and $b$; today is why that means anything.
  \end{itemize}
  \vspace{6pt}
  \begin{center}
