%! Exponential Growth and Decay — Unit 7, Lesson 7.1 — Exit Ticket (Answer Key)
...
\textbf{Sort the collected tickets into four piles} to decide how Lesson 7.2 opens:
...
struggle in 7.5 where the same reading drives the regression.
