%! Solving Exponential Equations with a Common Base — Unit 7, Lesson 7.3 — Guided Notes
...
\begin{itemize}\setlength{\itemsep}{1pt}
  ...
  \item Which fact about the \emph{shape} of an exponential graph (Lesson 7.0) guarantees the right-hand picture can never look like the left-hand one? \writeline
\end{itemize}
