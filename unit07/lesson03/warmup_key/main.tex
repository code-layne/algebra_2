%! Solving Exponential Equations with a Common Base — Unit 7, Lesson 7.3 — Warm-Up (Answer Key)
...
\emph{no turning points} or \emph{always increasing} (Lesson 7.0). Then say the consequence out loud
...
and $\sqrt[3]{7}=7^{1/3}$ are Lesson 6.1, and they are the reason Tier E can ask for
