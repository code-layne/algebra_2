%! Solving Exponential Equations with a Common Base — Unit 7, Lesson 7.3 — Group Activity (Answer Key)
...
exists that my method cannot find'' --- exactly the distinction Lesson 7.4 and Unit 8 are built on.
