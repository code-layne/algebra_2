%! Solving Exponential Equations with a Common Base — Unit 7, Lesson 7.3 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \end{itemize}
      \vspace{3pt}
      \begin{block}{Back to Lesson 7.0}
...
\begin{frame}[t, plain]
  ...
  \vspace{8pt}
  \begin{center}
    {\footnotesize This is Lesson 7.0's ``no turning points'' doing work, one full unit later --- and
    Unit 8 will use it again.}
  \end{center}
\end{frame}
...
\begin{frame}[t, plain]
  ...
  \vspace{8pt}
  \begin{center}
    {\footnotesize In Lesson 7.1 these were rules about \emph{models}. They turn out to be exactly the
...
% STEP 1 IS UNIT 6
\begin{frame}[t, plain]
  \forestheader{Step 1 is where the work is --- and it is all Unit 6}
...
\begin{frame}[t, plain]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.58\textwidth}
      ...
      from Lesson 7.2. All three have answers. None has a common base.}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{7.4} Compound interest, half-life, and $e$ --- real models, and $1000(1.05)^{t}=2000$, where $2$ is not a power of $1.05$.
    \item \textbf{7.5} Exponential regression --- technology fits the model; you decide whether it is the right family.
    \item \textbf{Unit 8} Logarithms --- the tool that finally names the crossing point of $y=2^{x}$ and $y=5$.
  \end{itemize}
  \vspace{6pt}
  \begin{center}
