%! Characteristics of Logarithmic Functions — Unit 7, Lesson 7.0 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{forestmid}\large\textbf{Unit 7 \quad Logarithmic Functions}}\\[6pt]
  {\color{white}\textbf{\large Lesson 7.0 \quad Characteristics of Logarithmic Functions}}
\end{center}
...
reaches. This is the difference from Unit~5: a square root got to \emph{stand on} its endpoint, but a
