%! Characteristics of Exponential Functions — Unit 7, Lesson 7.0 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 7.0 \quad Characteristics of Exponential Functions}}
\end{center}
...
\begin{enumerate}[leftmargin=1.5em, itemsep=5pt]
  ...
  \item \ldots{} explain why an exponential graph has \textbf{no} $x$-intercept and \textbf{no} absolute minimum, even though it clearly flattens out along a floor --- and \textbf{compare and contrast} exponential functions with the families from Units 2--6.
\end{enumerate}
...
the opposite of Unit 6, where the square root's \textbf{endpoint} was a point the graph actually
landed on. Unit 6 took away half the \textbf{domain}; Unit 7 hands it back and takes half the
\textbf{range} instead.
\end{remindbox}
