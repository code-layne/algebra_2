%! Characteristics of Exponential Functions — Unit 7, Lesson 7.0 — Group Activity (Answer Key)
...
left is the reflex answer from Unit 4's odd-degree polynomials, and it is wrong for a reason worth
...
Do \emph{not} let it become a lesson on reflections --- that is 7.2. The takeaway is narrower and
