%! Characteristics of Exponential Functions — Unit 7, Lesson 7.0 — Exit Ticket (Answer Key)
...
error of the lesson --- treating the asymptote as a value the function attains, exactly the Unit 6
...
Lesson 7.1 asks students to \emph{build} $y=ab^{x}$ from a story, so also check item 1's $a$ and $b$:
