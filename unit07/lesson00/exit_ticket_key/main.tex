%! Characteristics of Logarithmic Functions — Unit 7, Lesson 7.0 — Exit Ticket (Answer Key)
...
the flip; \textbf{C} gets the direction right but uses the Unit~5 radical bracket --- a logarithm
...
\textbf{Sort the collected tickets into four piles} to decide how Lesson~7.1 opens:
...
matters most: Lesson~7.1 re-derives the domain algebraically from the definition of a logarithm, so
