%! Graphing Exponential Functions and Transformations — Unit 7, Lesson 7.2 — Exit Ticket (Answer Key)
...
\begin{teachernote}
\textbf{Answer 4: A.} Each distractor is a named error. \textbf{B} is Lesson 7.0's bracket error --- the
...
\textbf{Sort the collected tickets into four piles} to decide how Lesson 7.3 opens:
...
point}. Lesson 7.5 leans on this same reading.
