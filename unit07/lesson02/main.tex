%! Graphing Exponential Functions and Transformations — Unit 7, Lesson 7.2 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 7.2: Graphing Exponential Functions and Transformations}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    item. \emph{Note:} Unit 7 has no \texttt{A2.EO} or \texttt{A2.EI} standard --- the unit rests
...
\begin{itemize}[leftmargin=1.1em, nosep, after=\vspace{2pt}]
  ...
  \item The asymptote is the \emph{boundary of the range} (Lesson 7.0). Move the boundary and the range moves; leave it and the range cannot change no matter how far sideways the graph slides.
...
\textbf{Horizontal asymptote $y=k$} & The boundary the range excludes (Lesson 7.0), now movable. \\
...
\begin{skillbox}[Hook]{forestbg}
    ...
    graph II crossing the $x$-axis and ask, \textbf{``In Lesson 7.0 you proved an exponential can
    never cross the $x$-axis. Explain that graph.''} Let the class resolve it --- 7.0's claim was
...
Three of the four columns are review from Units 3 and 6; the fourth --- \emph{does the asymptote
...
the red box. The bracket error ($[k,\infty)$) is Lesson 7.0's error wearing new clothes and will
reappear on the exit ticket. The second bullet is the one to say slowly: 7.0's ``no zeros, ever'' is
...
shift. Expect ``$-2^{x}$ is decay''; refuse it and point back at 7.0.
...
warning: a student who skips step 1 writes $a=5$ here, every time. This is the skill Lesson 7.5 leans
on. Preview Lesson~7.3.
\end{multicols}
\end{skillbox}
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item the horizontal-shift direction ($b^{\,x-3}$ moves \emph{right}), the Unit 3 / Unit 6 sign flip;
...
logarithms; that is Unit 8. \textbf{Preview:} Lesson~7.3, \emph{Solving Exponential Equations with a
