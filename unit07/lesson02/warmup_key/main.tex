%! Graphing Exponential Functions and Transformations — Unit 7, Lesson 7.2 — Warm-Up (Answer Key)
...
those two answers. Note the range: the parenthesis at $0$ is Lesson 7.0's headline and it comes back
today as $(k,\infty)$.
...
the negative-exponent property from Unit 6. Write $2^{-x}=\dfrac{1}{2^{x}}=\left(\dfrac12\right)^{x}$
