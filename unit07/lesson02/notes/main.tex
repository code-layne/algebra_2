%! Graphing Exponential Functions and Transformations — Unit 7, Lesson 7.2 — Guided Notes
...
\begin{itemize}\setlength{\itemsep}{1pt}
  ...
  \item In Lesson 7.0 you learned that an exponential function \textbf{never} crosses the $x$-axis. Graph II crosses it. What changed? \writeline
\end{itemize}
