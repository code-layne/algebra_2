...
| Activity / practice contexts | original scenarios and practice exercising each skill; the experience's two scenarios stretch prior knowledge into the new material, and Check Your Understanding — the lesson's only practice, since there is no homework — spans the difficulty the standards imply (no tiers) |
