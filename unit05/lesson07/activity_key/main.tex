%! Inverse Functions — Unit 5, Lesson 5.7 — Group Activity (Answer Key)
...
$\left(\sqrt{x}\,\right)^{2}$ versus $\sqrt{x^{2}}$ pair from Lesson 5.6, in disguise.}
...
\begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=5pt, start=13]
  ...
  \item The area of a circle is $A=\pi r^{2}$ --- the same shape of function. Solve it for $r$, and
        ...
        \ansline{This is the same move as Lesson 5.0's free-fall and skid-mark models --- context
...
finishes Part 3, send them to Part 4(o) and ask them to connect it to Lesson 5.0's free-fall model.
\end{teachernote}
