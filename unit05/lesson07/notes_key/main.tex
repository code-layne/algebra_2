%! Direct, Inverse \& Joint Variation — Unit 5, Lesson 5.7 — Guided Notes (Answer Key)
...
The graph & a \ans{line} through the origin & the \ans{hyperbola} from Lesson 5.4 \\
\hline
\end{tabularx}
\end{center}
...
is a direct variation --- exactly the 5.6 move of making the surface features identical so the real
...
It is the rational parent from 5.4, vertically stretched by $240$, with the axes as its asymptotes ---
...
A2.F.2f interpretation and the bridge from 5.6: rejecting $r=-30$ is a \emph{context} rejection, not an
extraneous one.
...
were shaky on 5.6 get a second pass at it here with friendly numbers.
