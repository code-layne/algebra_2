%! Inverse Functions — Unit 5, Lesson 5.7 — Homework (Answer Key)
...
because $\sqrt{4L}=2\sqrt{L}$ --- the flattening you first read off the graph in Lesson 5.0.}
...
\; Squaring is legal here because both sides are non-negative --- no extraneous root (5.5).}
...
5.0's free-fall and skid-mark models.
\end{teachernote}
