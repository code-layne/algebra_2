%! Direct, Inverse \& Joint Variation — Unit 5, Lesson 5.7 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 5.7: Direct, Inverse \& Joint Variation}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    \emph{origin} versus Lesson 5.4's hyperbola with the axes as asymptotes; and \emph{interpret} $k$, a
    ...
    parent and the vertical stretch that produces $y=\frac kx$, from 5.4) and \textbf{A2.F.2h}
    (the asymptotes, from 5.0). Builds on \textbf{A2.EI.4c} (5.6, interpreting and rejecting solutions).
...
\begin{itemize}[leftmargin=1.1em, nosep, after=\vspace{2pt}]
  ...
  \item 5.6 rejected answers because the algebra forbade them. Today the algebra is fine and the situation objects. Different reasons, different words.
\end{itemize}
\end{tabularx}
\end{skillbox}
...
\textbf{Inverse graph} & The Lesson 5.4 parent stretched by $k$: \TallMath{y=\frac kx,\quad \text{VA } x=0,\quad \text{HA } y=0} \\
...
\begin{fixedskillbox}[Activate Prior Knowledge \& Spiral Review]{forestbg}
    ...
    \textbf{(2)} The rational parent $y=\frac6x$ from 5.4: three evaluations and both asymptotes. This
    ...
    cross-multiplying, straight from 5.6 --- the fast route through every ``find the missing value''
...
\begin{skillbox}[Hook]{forestbg}
    ...
    steadily'' is not the test.} The Hook is built the way 5.6's was: identical surface features,
...
$rt=d$ in disguise. Then the graph, and this is the part to protect: $t=\frac{240}{r}$ is the 5.4 parent
...
on 5.6 get a second pass at cross-multiplying with friendly numbers. Insist they still write $k$ whenever
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item \textbf{``extraneous'' used for a context rejection} --- the 5.6 word, misapplied; today the algebra has no objection at all.
\end{itemize}
...
$y=3$, with asymptotes $x=0$ and $y=0$ (the unit's closing loop: the 5.4 parent stretched by $36$, and
...
no excluded input to build a wall at, no value it settles toward --- the 5.0 compare-and-contrast table,
...
the equation} and is thrown out anyway. That last part is the reason this lesson follows 5.6, and
...
meeting again at $(-2,-6)$. \textbf{Preview:} the \textbf{Unit 5 Test} --- this is the last lesson of the
