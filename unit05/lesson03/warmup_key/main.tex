%! Adding \& Subtracting Rational Expressions — Unit 5, Lesson 5.3 — Warm-Up (Answer Key)
...
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=3pt]
  ...
  \item To \emph{divide} by a fraction, multiply by its \ans{reciprocal} (Lesson 5.2):
...
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=3pt]
  ...
  \item Factor completely (the Unit 4 toolkit): \; $x^2-9=$ \ans{$(x-3)(x+3)$}; \quad
        $x^2-4=$ \ans{$(x-2)(x+2)$}; \quad $x^2+5x+6=$ \ans{$(x+2)(x+3)$}
\end{enumerate}

\vspace{4pt}
\textbf{3. Simplify and restrict} (Lesson 5.1). For $\dfrac{3x-9}{x^2-9}$:
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=3pt]
