%! Multiplying \& Dividing Radicals; Rationalizing — Unit 5, Lesson 5.3 — Guided Notes (Answer Key)
...
\textbf{The Lesson 2.4 callback is worth the ninety seconds.} Students met $(a+bi)(a-bi)=a^{2}+b^{2}$
...
size --- read forwards instead of backwards. Students who got $\sqrt[3]{9}$ wrong on the 5.2 exit
