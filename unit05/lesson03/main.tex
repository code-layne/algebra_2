%! Multiplying \& Dividing Radicals; Rationalizing — Unit 5, Lesson 5.3 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 5.3: Multiplying \& Dividing Radicals; Rationalizing}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    this lesson carries its \emph{multiplicative} half (Lesson 5.2 carried the additive half; that
    ...
    which 5.2 deliberately left open. \textbf{A2.EO.2c} (radical $\leftrightarrow$ rational
    ...
    \textbf{A2.EO.4c} (Lesson 2.4), where $(a+bi)(a-bi)$ served the identical purpose in a
...
\textbf{Product Property (forwards)} & \TallMath{\sqrt[n]{a}\cdot\sqrt[n]{b}=\sqrt[n]{ab}} --- same statement as Lesson 5.2, read the other direction. Indices must match. \\
...
mismatched indices once ($\sqrt2\cdot\sqrt[3]2=2^{5/6}$, Lesson 5.1) and move on.
...
term, generalize to $a^{2}-b$, and spend ninety seconds on the Lesson 2.4 callback:
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item \textbf{wrong multiplier at a higher index} --- $\frac{1}{\sqrt[3]2}\cdot\frac{\sqrt[3]2}{\sqrt[3]2}$; the same misconception as calling $\sqrt[3]{9}$ unfinished on the 5.2 exit ticket;
...
general proof and the 2.4 sign question. \textbf{(2)} Rationalizing the \textbf{numerator}:
...
how much of 5.4 opens with algebra; the explanation item, not any computation, is what identifies
students who are performing rationalizing as a ritual and will therefore not reach for it in Lesson
5.5, where nobody prompts for it by name.
\end{skillbox}
...
be repeated forever. \textbf{Preview:} Lesson 5.4, \emph{Graphing Radical Functions \&
Transformations} --- the algebra is finished, and the unit returns to the pictures from 5.0 with
