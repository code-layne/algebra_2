%! Adding \& Subtracting Rational Expressions — Unit 5, Lesson 5.3 — Warm-Up
...
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=3pt]
  ...
  \item You could also have used $12\cdot18=216$ as the denominator. Rewrite both fractions over
        ...
        \blank{4.2cm}
  \item To \emph{divide} by a fraction, multiply by its \blank{2.2cm} (Lesson 5.2):
...
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=3pt]
  ...
  \item Factor completely (the Unit 4 toolkit): \; $x^2-9=\blank{3.0cm}$; \quad
