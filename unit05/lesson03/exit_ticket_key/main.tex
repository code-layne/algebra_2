%! Adding \& Subtracting Rational Expressions — Unit 5, Lesson 5.3 — Exit Ticket (Answer Key)
...
$x\neq-2$ (read off the answer, which is Lesson 5.1's error at its third appearance).

\vspace{3pt}
Pile 2 is the one to re-teach: the parenthesis is the single most common lost point on this standard,
and it does not go away on its own. Pile 4 decides nothing about tomorrow --- 5.4 is graphing the parent
$y=1/x$ --- but it decides a great deal about \textbf{5.6}, where a solution landing on any excluded
