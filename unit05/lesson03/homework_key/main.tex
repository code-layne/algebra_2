%! Multiplying \& Dividing Radicals; Rationalizing — Unit 5, Lesson 5.3 — Homework (Answer Key)
...
the Unit 3 leading-minus error resurfacing.
...
Lesson 5.5 when it is not asked for by name.

\textbf{Item 5} closes the same kind of loop Lesson 5.2's homework closed: a procedure and its
