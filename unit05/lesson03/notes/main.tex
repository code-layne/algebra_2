%! Adding \& Subtracting Rational Expressions — Unit 5, Lesson 5.3 — Guided Notes
...
\blank{1.4cm} in the graph; $(x+2)$ stayed, so $x=-2$ is a \blank{1.4cm}. That sort is Lesson 5.0's,
