%! Characteristics of Radical Functions — Unit 5, Lesson 5.0 — Guided Notes
...
\end{itemize}
This is genuinely new. A polynomial (Unit~3) was defined \emph{everywhere}. A rational function
(Unit~4) lost a few scattered inputs where the denominator was zero. A square root function loses
...
\end{itemize}
\emph{Hold on to this.} It is the reason radical functions look the way they do, and Lessons 5.6 and
5.7 will make it a full method.
\end{notesbox}
