%! Characteristics of Radical Functions — Unit 5, Lesson 5.0 — Warm-Up (Answer Key)
...
the restricted domain that Lesson~5.7 will need. Do \emph{not} say ``index,'' ``radicand,'' or
