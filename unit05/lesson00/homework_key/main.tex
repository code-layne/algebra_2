%! Characteristics of Rational Functions — Unit 5, Lesson 5.0 — Homework (Answer Key)
...
\begin{spiralbox}
\textbf{Coming next --- Lesson 5.1: Simplifying Rational Expressions \& Domain Restrictions.} Today
...
\textbf{original} denominator. That last habit is the one that will save you in Lesson~5.6, when a
...
``vertical asymptote'' anywhere in it need the cancel test re-taught before 5.1. \textbf{Item 4} is
...
function has a vertical asymptote,'' which otherwise resurfaces in 5.5.
\end{teachernote}
