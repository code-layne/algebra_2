%! Characteristics of Rational Functions — Unit 5, Lesson 5.0 — Guided Notes (Answer Key)
...
which loses the hole entirely; this is the error the whole unit turns on (extraneous solutions in 5.6
