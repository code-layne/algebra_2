%! Characteristics of Radical Functions — Unit 5, Lesson 5.0 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  them.\\[8pt]
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{5.1} $n$th roots \& rational exponents --- what an index really is.
    \item \textbf{5.2--5.3} Simplifying, adding, multiplying, dividing \& rationalizing radicals.
    \item \textbf{5.4} Graphing radical functions \& transformations (the \emph{endpoint} moves).
    \item \textbf{5.5} Solving radical equations \& extraneous solutions.
    \item \textbf{5.6} Composition of functions.
    \item \textbf{5.7} Inverse functions --- today's last idea, made into a method.
  \end{itemize}
\end{frame}
