%! Graphing Radical Functions \& Transformations — Unit 5, Lesson 5.4 — Guided Notes
...
\begin{itemize}\setlength{\itemsep}{1pt}
  ...
  \item In Lesson~5.0 you found the domain of $\sqrt{x-3}$ by \emph{solving} $x-3\ge0$. Look at graph~II. Where could you have simply \emph{read} that answer? \writeline
\end{itemize}
