%! The Rational Parent Function \& Transformations — Unit 5, Lesson 5.4 — Group Activity (Answer Key)
...
\begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=5pt]
  \item Now write your answer as a \emph{single} fraction (Lesson 5.3, run forwards): \ans{$\frac{4x+9}{x+3}$}
...
\vspace{3pt}
\textbf{Tier E Part 1} is 5.5's algebra a day early and the proof of 5.0's degree rule here: the
