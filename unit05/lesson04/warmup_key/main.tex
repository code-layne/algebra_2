%! The Rational Parent Function \& Transformations — Unit 5, Lesson 5.4 — Warm-Up (Answer Key)
...
\vspace{4pt}
\textbf{1. The reciprocal, up close and far out} (Lesson 5.0). Complete the table for
$y=\dfrac{1}{x}$.
\begin{center}
...
\vspace{4pt}
\textbf{2. Transformations you already own} (Units 2--3). Name the turning point of each.
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=3pt]
  ...
  \item Fill in the rule you have used since Unit 2: a number attached \emph{outside} the function
...
\vspace{4pt}
\textbf{3. One function, two costumes} (Lessons 5.3 and 5.0).
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=3pt]
...
\vspace{3pt}
\textbf{Item 2} is the transformation rule from Units 2 and 3, stated in the general form students will
...
$2+\frac{3}{x-1}$ into $\frac{2x+1}{x-1}$, then find its asymptotes the Lesson 5.0 way --- and the
