%! Graphing Radical Functions \& Transformations — Unit 5, Lesson 5.4 — Guided Notes (Answer Key)
...
This is the \textbf{odd symmetry} from Lesson~5.0 doing work: flipping a cube root vertically and
...
doing $h$ and $k$ since Unit~1, and the only genuinely new word is \emph{anchor point}. Budget the
...
reason is Lesson 5.0's odd symmetry, so name it.
