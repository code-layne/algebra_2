%! The Rational Parent Function \& Transformations — Unit 5, Lesson 5.4 — Homework (Answer Key)
...
\begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=5pt]
  \item Write your answer as a single fraction (Lesson 5.3, run forwards): \ans{$\frac{-3x+8}{x-4}$}
...
should test $x=0$ ($0$ vs.\ $4$). \textbf{Problem 5} seeds \textbf{5.7} --- Table I is an inverse
