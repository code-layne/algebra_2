%! Solving Rational Equations — Unit 5, Lesson 5.6 — Homework (Answer Key)
...
first when grading. Part (c) is a deliberate callback to 5.5: $c=4$ is a vertical asymptote of the
