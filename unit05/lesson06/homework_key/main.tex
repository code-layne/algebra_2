%! Composition of Functions — Unit 5, Lesson 5.6 — Homework (Answer Key)
...
\begin{itemize}[leftmargin=1.3em, nosep]
  \item \textbf{Item 2(g) is the first backwards question} students have seen on compositions, and
        it is the seed of 5.7: to hit a target output you have to un-do the outer machine first.
  ...
  \item \textbf{Item 6 is the bridge to 5.7 --- read these before planning tomorrow.} A student who
        ...
        not, and 5.7 should open by re-running Notes Section 6 for them.
  \item \textbf{The extension} deliberately ends where Lesson 5.4 began: a real formula turns out to
