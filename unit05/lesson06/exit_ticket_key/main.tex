%! Composition of Functions — Unit 5, Lesson 5.6 — Exit Ticket (Answer Key)
  ...
  \item \textbf{SOL-style multiple choice.} If $f(x)=x^{2}$ and $g(x)=x-5$, which expression is
        ...
        \begin{itemize}[leftmargin=1.4em, nosep]
          ...
          \item \textbf{C} expands $(x-5)^{2}$ as $x^{2}-25$: the perfect-square trinomial error from
                Unit 3, still alive. Correct expansion is $x^{2}-10x+25$.
...
\begin{teachernote}
\small Graded for completion. Sort into four piles; they decide how 5.7 opens.
\begin{itemize}[leftmargin=1.3em, nosep]
  ...
  \item \textbf{Composed correctly, domain missing} --- item 2(b) answered ``all reals.'' They are
        ...
        \emph{before} 5.7, because the entire restricted-domain argument there depends on it.
...
what makes the $\left(\sqrt{x}\,\right)^{2}=x$ surprise land in Lesson 5.7.
\end{teachernote}
