%! Solving Rational Equations — Unit 5, Lesson 5.6 — Guided Notes (Answer Key)
...
Lesson 5.5 on it: the factor $x+1$ cancels, so $x=-1$ is a \ans{hole}; the factor $x-1$ survives,
...
\vspace{3pt}
\textbf{Section 1 is worth its two minutes.} Students who have just spent 5.3 building common
...
\vspace{3pt}
\textbf{Section 5's graph is where 5.5 pays its debt.} The combined function is
