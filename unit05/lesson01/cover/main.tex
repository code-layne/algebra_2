...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 5.1 \quad Simplifying Rational Expressions \& Domain Restrictions}}
\end{center}
...
the two features you read off graphs in Lesson 5.0, now produced by algebra. Watch for
