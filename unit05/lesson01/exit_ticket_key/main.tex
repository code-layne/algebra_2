%! Simplifying Rational Expressions — Unit 5, Lesson 5.1 — Exit Ticket (Answer Key)
...
in Lesson~5.6, so a re-teach now is cheaper than one then. Item~2 earns full credit only if the student
