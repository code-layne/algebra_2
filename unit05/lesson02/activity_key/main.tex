%! Multiplying \& Dividing Rational Expressions — Unit 5, Lesson 5.2 — Group Activity (Answer Key)
...
from the divisor. Row 4 is the Lesson~5.1 sign check; accept $-x(x+3)$, $-(x^2+3x)$, or
