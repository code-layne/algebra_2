%! Multiplying \& Dividing Rational Expressions — Unit 5, Lesson 5.2 — Exit Ticket (Answer Key)
...
restrictions from the answer} --- chose \textbf{A}, which is Lesson 5.1's error still unresolved;
...
today, and it returns in 5.3 (a complex fraction is a division, so its bottom fraction's numerator is
restricted) and again in 5.6, where a solution that lands on \emph{any} of these values is extraneous.
