%! Multiplying \& Dividing Rational Expressions — Unit 5, Lesson 5.2 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 5.2: Multiplying \& Dividing Rational Expressions}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    \textbf{A2.EO.3b} (factor completely, Lesson~4.2) and Lesson~5.1's restriction habit; it is the
    prerequisite for \textbf{A2.EO.1a/c} (5.3 --- a complex fraction \emph{is} a division) and for
...
\begin{itemize}[leftmargin=1.1em, nosep, after=\vspace{2pt}]
  \item \textbf{Factor everything first} --- the Unit~4 toolkit, now applied to four polynomials at once.
  ...
  \item Connect back to 5.0/5.1: every restriction is a \textbf{hole} or a \textbf{wall} on the graph.
\end{itemize}
&
\vspace{-6pt}
\begin{itemize}[leftmargin=1.1em, nosep, after=\vspace{2pt}]
...
\textbf{Opposite binomials} & Same terms, every sign flipped; their quotient is $-1$ (Lesson 5.1, still in force). \\
...
\begin{fixedskillbox}[Activate Prior Knowledge \& Spiral Review]{forestbg}
    ...
    and restrict} $\frac{x^2+3x}{x^2-9}$ with the hole/wall sort, carrying Lesson~5.1 forward intact.
...
\emph{expanded} product hides its own factors and Unit~4 measured exactly what it costs to get them
...
\textbf{2. The four steps, one more denominator.} Same four steps as 5.1 --- factor, restrict, divide
...
excluded anyway. Name where this returns: \textbf{5.3} (a complex fraction is combine-then-divide),
\textbf{5.5} (every restriction becomes a hole or a wall), \textbf{5.6} (an extraneous solution is a
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item \textbf{missing the divisor's-numerator restriction} --- the signature error of the lesson, and the one that returns in 5.3 and 5.6;
...
source-3 pile decides whether 5.3 opens with a re-teach --- a complex fraction is a division, so the
...
$x\neq3,0,-1$, then describe the resulting line with three holes (a direct preview of 5.5).
\textbf{Preview:} Lesson~5.3, \emph{Adding \& Subtracting Rational Expressions} --- where a common
