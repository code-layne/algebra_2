%! Multiplying \& Dividing Rational Expressions — Unit 5, Lesson 5.2 — Homework (Answer Key)
...
\begin{spiralbox}
\textbf{Coming next --- Lesson 5.3: Adding \& Subtracting Rational Expressions (and complex
...
\textbf{Item 2(e)} is the Lesson 5.1 sign check --- $7-x=-(x-7)$, so the answer is $-3(x+7)$; a missing
...
has a partner upstairs so nothing is left over. Part (b) previews 5.5 directly: a polynomial answer
