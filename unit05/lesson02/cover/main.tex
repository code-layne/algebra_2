%! Simplifying Radicals; Adding \& Subtracting — Unit 5, Lesson 5.2 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 5.2 \quad Simplifying Radicals; Adding \& Subtracting}}
\end{center}
