%! Solving Radical Equations \& Extraneous Solutions — Unit 5, Lesson 5.5 — Exit Ticket (Answer Key)
...
\begin{teachernote}
\small Graded for completion. Sort into four piles; they decide how 5.6 opens and what needs a
re-teach first.
\begin{itemize}[leftmargin=1.3em, nosep]
  ...
  \item \textbf{Index confusion} --- item 3 $=$ B. This is the Unit 5 spine failing, not a
