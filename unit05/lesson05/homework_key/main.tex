%! Solving Radical Equations \& Extraneous Solutions — Unit 5, Lesson 5.5 — Homework (Answer Key)
...
\]
In Lesson 5.0 you were given $d$ and found $s$. An investigator has the opposite problem: they know
...
\begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=5pt]
  ...
  \item Solving $s=\sqrt{24d}$ for $d$ in general gives $d=\dfrac{s^{2}}{24}$ --- and this is exactly
        the formula you derived in the Lesson 5.0 homework. You obtained it by squaring both sides,
...
\begin{spiralbox}
\textbf{Coming next --- Lesson 5.6: Composition of Functions.} Today you undid a radical by raising
both sides to a power --- one operation cancelling another. That idea is about to get a name and a
notation. In 5.6 you will feed one function's output straight into another function,
$(f\circ g)(x)=f(g(x))$, and find out that the order matters enormously. Then in 5.7 composition
...
you first noticed all the way back in Lesson 5.0.
\end{spiralbox}
...
\begin{itemize}[leftmargin=1.3em, nosep]
  ...
  \item \textbf{The extension} closes a loop opened in 5.0, where students derived $d=s^{2}/24$ from
