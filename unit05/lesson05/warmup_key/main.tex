%! Solving Radical Equations \& Extraneous Solutions — Unit 5, Lesson 5.5 — Warm-Up (Answer Key)
...
\vspace{4pt}
\textbf{1. Undoing a radical (Lessons 5.1 and 5.3).} Simplify each expression. Assume $x$ is large
...
of a sum, so squaring meant FOIL (Lesson 5.3), and the middle term $6\sqrt{x}$ still has a radical
in it.}
...
\vspace{4pt}
\textbf{3. Factoring, from Unit 2.} Solve by factoring.
\[
