...
% GRADUAL RELEASE (course-wide shape, 2026-09-01): this is the "I do / we do" block — 20 minutes
% including the Guided Practice box — and the Individual Practice block that closes it is the
% "you do alone", 15 more. There is no group activity. The vocabulary is BUILT HERE, before the
% practice uses it. Budget: 4pp, with Individual Practice landing on its own clean page.
% Reference implementations: unit01/lesson01/notes and unit01/lesson02/notes.
...
% GUIDED PRACTICE — the "we do". Everything at once on ONE new example, worked WITH the class —
% it is the last thing students see before working alone.
\begin{practicebox}
...
% INDIVIDUAL PRACTICE — the "you do alone" (15 min, silent). A scenariobox[...]{navy} — no new
% environment. THREE problems, deliberately the three shapes/directions of the skill, each with a
% work block where there is algebra. \boxguard[22] so it lands on its own clean page.
\boxguard[22]
\begin{scenariobox}[Individual Practice --- On Your Own]{navy}
Three problems, quietly and on your own. TODO: the one-sentence rule to apply.
\begin{enumerate}[leftmargin=1.9em, itemsep=9pt]
  \item \textbf{TODO shape 1.} TODO \blank{1.2cm}
        \begin{work}
          % TODO
          2x - 4 &= 0 \\
               x &= 2
        \end{work}
  \item \textbf{TODO shape 2.} TODO \blank{1.2cm}
  \item \textbf{TODO shape 3 --- the crux.} TODO. A classmate claims TODO --- what did they miss?
        \par\writelines{2}
\end{enumerate}
\end{scenariobox}
