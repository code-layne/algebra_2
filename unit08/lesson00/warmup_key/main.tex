%! Characteristics of Logarithmic Functions — Unit 8, Lesson 8.0 — Warm-Up (Answer Key)
...
\vspace{3pt}
\textbf{2. Read the exponential parent.} The graph is $y=2^x$ from Unit~7.
\begin{center}
...
\textbf{Item 1} splits into the two halves of the lesson. Parts (a)--(c) are Unit~7 review; parts
...
logarithmic graph. Note the contrast with Unit~6 if it comes up: $y=x^2$ had to be cut in half before
