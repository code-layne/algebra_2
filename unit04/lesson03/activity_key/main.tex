%! Adding \& Subtracting Rational Expressions — Unit 4, Lesson 4.3 — Group Activity (Answer Key)
...
\begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=6pt]
  ...
  \item One method leaves \emph{every} restriction readable somewhere on the page; the other erases
        ...
        \ansline{$(4-x)(4+x)$ is the divisor's numerator from Lesson 4.2 --- which is where $x\neq4,-4$ come from.}
\end{enumerate}
...
the restrictions. That is the same trade students met in 4.1 (cancelling) and 4.2 (flipping), now for
