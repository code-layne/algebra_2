%! Adding \& Subtracting Rational Expressions — Unit 4, Lesson 4.3 — Slides (Beamer)
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{The one warning}
        ...
        is Lesson 4.1's error, and it is still wrong.
      \end{block}
    \end{column}
  \end{columns}
  \vspace{8pt}
...
\begin{frame}[t, plain]
  ...
  \begin{center}
    ...
    \emph{whole bottom} ($4-x\neq0$, so $x\neq4$) --- Lesson 4.2's source 3 in a new coat.
  \end{center}
\end{frame}
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{4.4} The parent $y=\frac1x$: these expressions go back on the grid, and shifting one
          \emph{moves its asymptotes}.
    \item \textbf{4.5} Graphing from the equation: every restriction you list becomes a hole or a wall.
    \item \textbf{4.6} Solving rational equations --- you will multiply through by an LCD, and any
