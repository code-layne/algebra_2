%! Dividing Polynomials; Remainder and Factor Theorems — Unit 4, Lesson 4.3 — Exit Ticket (Answer Key)
...
``forgot to finish'' pile, and it is the same habit Lesson~4.2 was built around. A correct
...
Lesson~4.4 (write $x+1 = x-(-1)$ every time). A large ``stopped early'' pile matters more, because
Lesson~4.4's whole method is test $\rightarrow$ divide $\rightarrow$ \emph{finish}.
\end{teachernote}
