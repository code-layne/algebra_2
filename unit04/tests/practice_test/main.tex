%! Unit 4: Polynomial Functions — Summative Assessment — Practice Test --- Study Copy (blank)
...
\pageheader{Unit 4: Polynomial Functions}{Practice Test --- Study Copy}
\namedateperiod
...
\begin{enumerate}[leftmargin=1.9em, itemsep=10pt]
  \item \textbf{Read the graph.} The polynomial function $f$ is graphed below. Each gridline is one unit.
        ...
        \\[4pt]
        (f) Interval(s) where $f$ is increasing: \blank{2.6cm}; \quad domain: \blank{2.0cm}; \quad range: \blank{2.0cm}
  ...
  \item \textbf{Solve over the complex numbers.} $x^3-3x^2+4x-12=0$
        ...
        $y=x^3-3x^2+4x-12$ therefore have? \blank{5.0cm}
