%! Direct, Inverse \& Joint Variation — Unit 4, Lesson 4.7 — Homework (Answer Key)
...
end behavior that runs off to infinity rather than settling. That is exactly the 4.0 compare-and-contrast
...
handle because $w>0$ already. Part (f) is the whole point of following 4.6 with this lesson --- $w=-60$
