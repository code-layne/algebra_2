%! Direct, Inverse \& Joint Variation — Unit 4, Lesson 4.7 — Student Packet Cover Sheet
...
\begin{center}
  ...
  {\color{white}\textbf{\large Lesson 4.7 \quad Direct, Inverse \& Joint Variation}}
\end{center}
...
\begin{enumerate}[leftmargin=1.5em, itemsep=5pt]
  ...
  \item \ldots{} \textbf{recognize} each graph on sight: a direct variation is a line through the
        \emph{origin}; an inverse variation is Lesson 4.4's hyperbola, with the axes as its asymptotes.
...
parent from Lesson 4.4 with the axes as its asymptotes. \textbf{If neither row is constant, the answer
