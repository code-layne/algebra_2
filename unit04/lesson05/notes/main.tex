%! Graphing Rational Functions — Unit 4, Lesson 4.5 — Guided Notes
...
So yes, and the crossing point is the \blank{2.4cm}. In 4.4 the numerator was a nonzero constant and a
...
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
  ...
  \item It \textbf{may} cross a horizontal asymptote, and if it does, the crossing is at an
        \blank{2.4cm}. (A transformed parent from 4.4 never can; its numerator is a nonzero
        constant.)
