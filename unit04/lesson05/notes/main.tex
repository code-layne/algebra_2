%! Fundamental Theorem of Algebra and Complex Zeros — Unit 4, Lesson 4.5 — Guided Notes
...
(Lesson 4.3), $(x - r_1)$ is then a \blank{2.0cm} of $f$, so dividing leaves a quotient of degree
...
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
  ...
  \item Lesson 4.0 check: at the double zero the graph \blank{2.0cm} the axis; at the single zero it
...
\begin{itemize}[leftmargin=1.5em, itemsep=4pt]
  ...
  \item \textbf{Lesson 4.0 agrees.} An odd-degree graph has arms pointing in \blank{2.4cm}
