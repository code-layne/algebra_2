%! Graphing Rational Functions — Unit 4, Lesson 4.5 — Exit Ticket (Answer Key)
...
\vspace{3pt}
Pile 3 is the fastest fix. \textbf{Pile 2 is the one to re-teach before 4.6}, where the same error --- a
...
is impossible for exactly Lesson 4.4's reason. A student who answers ``no, graphs can never cross an
