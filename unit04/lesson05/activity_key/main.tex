%! Fundamental Theorem of Algebra and Complex Zeros — Unit 4, Lesson 4.5 — Group Activity (Answer Key)
...
fix is the degree-4 end behavior from Lesson~4.0 (both arms up, so the graph leaves and never
returns).
...
item~1, it is a Lesson~4.4 problem (candidate lists), not a Lesson~4.5 problem --- rebuild the list
