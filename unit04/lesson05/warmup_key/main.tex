%! Graphing Rational Functions — Unit 4, Lesson 4.5 — Warm-Up (Answer Key)
...
\vspace{3pt}
\textbf{Item 1} is the cancel test from 4.0, driven by 4.1's algebra. The line to insist on is 1(b): the
...
\vspace{3pt}
\textbf{Item 3} is the new skill, disguised as review. Students have built sign charts since 3.6, but
