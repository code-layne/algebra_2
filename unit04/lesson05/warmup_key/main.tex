%! Fundamental Theorem of Algebra and Complex Zeros — Unit 4, Lesson 4.5 — Warm-Up (Answer Key)
...
\vspace{5pt}
\textbf{1. Conjugates multiply to something real} (Lesson 3.4). Recall $i^2 = $ \ans{$-1$}
...
from Lesson~3.4 --- the mechanism that lets a polynomial with \emph{real} coefficients own an
imaginary zero. Item~2 rebuilds the two finishing moves for a quadratic and, in part (c), gets
students to \emph{notice} the pairing before it is named. Item~3 is Lesson~4.4's Tier E cliffhanger,
