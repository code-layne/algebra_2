%! Graphing Rational Functions — Unit 4, Lesson 4.5 — Group Activity
...
\blank{1.6cm} horizontal asymptote. Divide anyway --- Lesson 3.3, long division:
\begin{center}
...
\begin{enumerate}[label=(\alph*), leftmargin=2.1em, itemsep=5pt]
  \item Combine into a single fraction (Lesson 4.3): \; $T(x)=\dfrac{\rule{2.6cm}{0.4pt}}%
        {\rule{2.6cm}{0.4pt}}$
