%! Fundamental Theorem of Algebra and Complex Zeros — Unit 4, Lesson 4.5 — Group Activity
...
\begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=6pt]
  ...
  \item So the number of imaginary zeros is \blank{1.4cm}, and $n$ is \blank{1.4cm}. An odd number
        ...
        \blank{1.0cm}.
  \item \textbf{Same conclusion, from Lesson 4.0.} An odd-degree polynomial's end behavior sends its
