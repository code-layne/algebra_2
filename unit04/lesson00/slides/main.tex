%! Characteristics of Polynomial Functions — Unit 4, Lesson 4.0 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{4.1} Operations with polynomials (add, subtract, multiply).
    \item \textbf{4.2} Advanced factoring (grouping, sum \& difference of cubes).
