%! Characteristics of Rational Functions — Unit 4, Lesson 4.0 — Slides (Beamer)
...
% ROADMAP
\begin{frame}[t, plain]
  \forestheader{Where Unit 4 goes next}
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{4.1} Simplifying rational expressions \& domain restrictions.
    \item \textbf{4.2--4.3} Multiplying, dividing, adding \& subtracting rational expressions.
    \item \textbf{4.4} The parent $y=\frac1x$ and transformations (the asymptotes move).
    \item \textbf{4.5} Graphing rational functions from the equation.
    \item \textbf{4.6} Solving rational equations \& extraneous solutions.
    \item \textbf{4.7} Direct, inverse \& joint variation.
  \end{itemize}
\end{frame}
