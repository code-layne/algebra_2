...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    the parabola toolkit from Unit~3 to curves that turn more than once.
    \\[2pt]
...
$g$ and preview Lesson~4.1, \emph{operations with polynomials}.
\end{multicols}
\end{skillbox}
...
end-behavior slip'' to decide whether Lesson~4.1 opens with a quick re-teach.
\end{skillbox}
...
\textbf{Preview:} Lesson~4.1, \emph{Operations with Polynomials} --- adding, subtracting, and
