%! Characteristics of Rational Functions — Unit 4, Lesson 4.0 — Exit Ticket (Answer Key)
...
Lesson~4.1 opens with a re-teach: \textbf{(1) got it}; \textbf{(2) bare-number slip} --- wrote ``$-1$''
...
the domain; \textbf{(4) hole-vs-asymptote slip} --- missed item~3, which is the idea Lesson~4.1 is
