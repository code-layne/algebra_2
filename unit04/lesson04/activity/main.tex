%! The Rational Parent Function \& Transformations — Unit 4, Lesson 4.4 — Group Activity
...
\begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=5pt]
  \item Now write your answer as a \emph{single} fraction (Lesson 4.3, run forwards): \blank{3.0cm}
