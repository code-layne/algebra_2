%! Zeros of Polynomials: the Rational Root Theorem — Unit 4, Lesson 4.4 — Guided Notes (Answer Key)
...
\begin{enumerate}[leftmargin=1.7em, itemsep=6pt, start=6]
  ...
  \item \textbf{Looking ahead.} Suppose a different cubic's depressed polynomial had come out
        ...
        What kind of numbers would its solutions be? \ans{imaginary ($\pm 2i$)} \; That is Lesson 4.5.
\end{enumerate}
\end{practicebox}
...
\vspace{3pt}
\textbf{Practice B is the bridge to Lesson 4.5} and should not be cut. Item 8's $\pm\sqrt2$ makes
