%! Zeros of Polynomials: the Rational Root Theorem — Unit 4, Lesson 4.4 — Lesson Plan
...
\newcommand{\LessonNumberName}{Lesson 4.4: Zeros of Polynomials: the Rational Root Theorem}
...
\begin{tcolorbox}[colback=forestbg, colframe=forest, boxrule=0.9pt, arc=2mm,
    ...
    three or higher (today over the reals; the complex case is Lesson~4.5) --- and
...
\begin{fixedskillbox}[Activate Prior Knowledge \& Spiral Review]{forestbg}
    ...
    bookkeeping that most students lose points on. \textbf{(3)} \emph{Finishing Lesson~4.3's Tier E
...
\begin{skillbox}[Hook]{forestbg}
    ...
    \textbf{``Lesson 4.3 could crack any polynomial --- as long as somebody told you which number to
...
\begin{itemize}[leftmargin=1.2em, nosep]
  ...
  \item stopping at the \textbf{depressed polynomial} instead of factoring completely (still Lesson 4.2's standard);
...
$x^3+2x^2-x-2$ solved independently (and re-derived by grouping, a Lesson~4.2 callback). The third
...
build $6x^3+x^2-4x+1$ from the zeros $\tfrac12$, $\tfrac13$, $-1$ (the A2.EI.6a skill Lesson~4.5
...
Lesson~4.5 assumes students can produce a candidate list unaided. Watch specifically for zeros
...
workflow twice; a ``no hints this time'' item on $x^3+2x^2-5x-6$ --- Lesson~4.3's exit ticket, where
...
leading coefficient could be? \textbf{Preview:} Lesson~4.5, the \emph{Fundamental Theorem of
