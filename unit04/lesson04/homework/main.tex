%! The Rational Parent Function \& Transformations — Unit 4, Lesson 4.4 — Homework
...
\begin{enumerate}[label=(\alph*), leftmargin=1.9em, itemsep=5pt]
  \item Write your answer as a single fraction (Lesson 4.3, run forwards): \blank{3.0cm}
