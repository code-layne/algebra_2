%! Operations with Polynomials — Unit 4, Lesson 4.1 — Exit Ticket (Answer Key)
...
``nothing to pair with.'' Item~2's last line is the Lesson~4.0 link --- students who expand correctly
...
\textbf{B} or \textbf{C} is worth a five-minute re-open of Lesson~4.2.
\end{teachernote}
