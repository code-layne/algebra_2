%! Operations with Polynomials — Unit 4, Lesson 4.1 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{5pt}
    ...
    \item Degree \emph{odd}, lead \emph{negative} $\Rightarrow$ (Lesson 4.0) left arm \textbf{up},
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{4.2} Advanced factoring --- today's products run \emph{backward}, plus the sum and difference of cubes.
    \item \textbf{4.3} Dividing polynomials; Remainder \& Factor Theorems.
    \item \textbf{4.4--4.5} Zeros: Rational Root Theorem; complex zeros \& the FTA.
