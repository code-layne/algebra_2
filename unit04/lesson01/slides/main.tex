%! Simplifying Rational Expressions — Unit 4, Lesson 4.1 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.54\textwidth}
      ...
      \end{block}
      \vspace{3pt}
      {\footnotesize This is Lesson 4.0's cancel test, run from the algebra side. The hole's height
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{4.2--4.3} Multiply, divide, add \& subtract --- every one of them starts by factoring.
    \item \textbf{4.5} Graphing from the equation: the cancel test decides hole vs.\ wall.
    \item \textbf{4.6} Solving rational equations --- an ``extraneous solution'' is nothing but one of
