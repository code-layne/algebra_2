%! Operations with Polynomials — Unit 4, Lesson 4.1 — Guided Notes (Answer Key)
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
  ...
  \item So (Lesson 4.0) the degree is \emph{odd} and the leading coefficient is \emph{negative}:
