%! Graphing Polynomial Functions and Modeling — Unit 4, Lesson 4.6 — Slides (Beamer)
...
\begin{frame}[t, plain]
  ...
  \begin{enumerate}\setlength{\itemsep}{4pt}
    ...
    \item \textbf{Factor completely} $\Rightarrow$ the $x$-intercepts. \hfill {\scriptsize(4.2--4.4)}
    \item \textbf{Multiplicity of each zero} $\Rightarrow$ cross, touch, or flatten. \hfill {\scriptsize(4.0)}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Coming next}
        \textbf{The Unit 4 test}, and then \textbf{Unit 5: Rational Functions} --- a polynomial in a
