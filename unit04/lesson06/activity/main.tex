%! Graphing Polynomial Functions and Modeling — Unit 4, Lesson 4.6 — Group Activity
...
\begin{enumerate}[leftmargin=1.7em, itemsep=10pt]
  \item \textbf{Factor first, then predict.} $f(x) = x^3 - x^2 - 6x$
    ...
    \vspace{2pt}
    (a) Factor completely (GCF first --- Lesson 4.2): \blank{5.0cm}
...
\begin{enumerate}[label=(\alph*), leftmargin=1.8em, itemsep=6pt]
  ...
  \item List the possible rational zeros of that cubic (Lesson 4.4): \blank{6.0cm}
