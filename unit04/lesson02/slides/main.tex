%! Advanced Factoring — Unit 4, Lesson 4.2 — Slides (Beamer)
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}\setlength{\itemsep}{4pt}
        \item In Lesson 4.0 you read four $x$-intercepts off its graph: $-2,\,-1,\,1,\,2$.
    ...
    \begin{column}{0.46\textwidth}
      \begin{block}{Yesterday $\rightarrow$ today}
        \textbf{4.1:} factored $\rightarrow$ standard, by multiplying. \\[4pt]
        \textbf{4.2:} standard $\rightarrow$ factored, and the prize is the \emph{zeros}.
      \end{block}
      \vspace{3pt}
...
\begin{frame}[t, plain]
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      \[ = (x-1)(x+1)(x-2)(x+2) \]
      \vspace{2pt}
      Zeros: $1,\,-1,\,2,\,-2$ --- exactly the four intercepts from Lesson 4.0. \textbf{Loop closed.}
    \end{column}
    \begin{column}{0.48\textwidth}
...
\begin{frame}[t, plain]
  ...
  \begin{itemize}\setlength{\itemsep}{3pt}
    \item \textbf{4.3} Dividing polynomials; Remainder \& Factor Theorems --- the tool that gets past today's wall.
    \item \textbf{4.4} Zeros of polynomials: the Rational Root Theorem.
